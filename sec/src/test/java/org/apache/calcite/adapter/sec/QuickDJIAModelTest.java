...
/**
 * Quick test of DJIA 5-year model.
 */
@Tag("unit")
public class QuickDJIAModelTest {

  @Test public void testDJIAModelLoading() throws Exception {
    System.out.println("\n"
  + "=".repeat(80));
    System.out.println("QUICK TEST: DJIA 5-YEAR MODEL");
    ...
    try (Connection conn = DriverManager.getConnection("jdbc:calcite:", info)) {
      ...
      try (Statement stmt = conn.createStatement();
           ResultSet rs =
             stmt.executeQuery("SELECT COUNT(*) as cnt FROM financial_line_items")) {
  ...
  public void testRealDJIADownload() throws Exception {
    System.out.println("\n"
  + "=".repeat(80));
    System.out.println("REAL DJIA DOWNLOAD TEST (LIMITED)");
    System.out.println("=".repeat(80) + "\n");
    ...
    try (Connection conn = DriverManager.getConnection("jdbc:calcite:", info)) {
      ...
      try (Statement stmt = conn.createStatement();
           ResultSet rs =
             stmt.executeQuery("SELECT DISTINCT company_name, filing_type, filing_date " +
