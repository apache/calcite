...
/**
 * Test for DJIA Net Income Analysis using XBRL financial facts.
 */
@Tag("integration")
public class DJIANetIncomeAnalysisTest {

  @Test public void testDJIANetIncomeAnalysis() throws Exception {
    System.out.println("================================================================================");
    ...
    props.put("inline", model);  // Use inline model, not model file path
    props.put("lex", "ORACLE");
    props.put("unquotedCasing", "TO_LOWER");

    System.out.println("Connecting to SEC adapter for DJIA companies...");
    System.out.println("Configuration:");
    System.out.println("  - Companies: _DJIA group (30 Dow Jones companies)");
