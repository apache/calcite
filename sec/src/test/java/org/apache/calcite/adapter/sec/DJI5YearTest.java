...
/**
 * Test SEC adapter downloading 5 years of DJI company filings.
 */
@Tag("integration")
public class DJI5YearTest {
  ...
  public void testDJISampleQuery() throws Exception {
    ...
    try (Connection conn = DriverManager.getConnection("jdbc:calcite:", info)) {
      ...
      System.out.println("Querying DJI company filings (2020-2024):");
    ...
    System.out.println("  ✓ Successfully connected to DJI 5-year SEC data");
    System.out.println("=".repeat(80));
  }
  ...
  public void testDJIQuickQuery() throws Exception {
    ...
    try (Connection conn = DriverManager.getConnection("jdbc:calcite:", info);
         ...
         ResultSet rs = stmt.executeQuery(
           "SELECT DISTINCT company_name FROM financial_line_items")) {
