...
@Tag("integration")
public class DJIWikipediaTest {
  @Test
public void test() throws Exception {
    System.out.println("\n"
  + "=".repeat(80));
    System.out.println("TESTING DJI WIKIPEDIA SCRAPING");
    System.out.println("=".repeat(80) + "\n");

    // Clear cache to force fresh fetch
    java.io.File cacheDir = new java.io.File(System.getProperty("user.home"), ".calcite/sec-cache");
    java.io.File cacheFile = new java.io.File(cacheDir, "_DJI_CONSTITUENTS.json");
    if (cacheFile.exists()) {
      cacheFile.delete();
      System.out.println("Cleared cache file: " + cacheFile);
    }

    System.out.println("Fetching DJI constituents (should try Wikipedia first)...\n");
