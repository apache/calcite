...
/**
 * Test downloading SEC filings for DJIA companies.
 */
@Tag("integration")
public class DJIADownloadTest {

  @Test public void testDownloadDJIACompanies() throws Exception {
    System.out.println("\n"
  + "=".repeat(80));
    System.out.println("TESTING DJIA COMPANIES SEC DOWNLOAD");
    System.out.println("=".repeat(80) + "\n");

    // Get DJIA constituent CIKs
    System.out.println("Fetching DJIA constituent CIKs...");
    List<String> djiCiks = SecDataFetcher.fetchDJIAAConstituents();
    System.out.println("Found " + djiCiks.size() + " DJIA companies\n");
    ...
    System.out.println("\n"
  + "=".repeat(80));
    System.out.println("✓ SUCCESS: Downloaded " + xmlFiles.length + " DJIA company filings");
    System.out.println("=".repeat(80));
