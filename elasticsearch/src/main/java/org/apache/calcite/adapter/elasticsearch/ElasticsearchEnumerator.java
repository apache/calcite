...
public class ElasticsearchEnumerator implements Enumerator<Object> {
   ...
   * @param cursor Elasticsearch iterator (usually a {@link java.util.Iterator})
  ...
  public static Function1<SearchHit, Object> getter(List<Map.Entry<String, Class>> fields) {
