...
public class ElasticsearchSchemaFactory implements SchemaFactory {
  ...
  @Override public Schema create(SchemaPlus parentSchema, String name,
    ...
    try {
      Map<String, Integer> coordinates = mapper.readValue(
        (String) map.get("coordinates"), new TypeReference<Map<String, Integer>>() { });
      Map<String, String> userConfig = mapper.readValue((String) map.get("userConfig"),
