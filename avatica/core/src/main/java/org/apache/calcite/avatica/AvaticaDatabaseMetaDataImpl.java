 ...
 */
public class AvaticaDatabaseMetaDataImpl implements AvaticaDatabaseMetaData {
  private final AvaticaConnection connection;

  protected  AvaticaDatabaseMetaDataImpl(AvaticaConnection connection) {
...
// End AvaticaDatabaseMetaDataImpl.java
