...
public class AvaticaRuntimeException extends RuntimeException {
  ...
  /**
   * Construct an instance of this exception with no additional information. It is strongly
   * preferred that the caller invoke {@link #AvaticaRuntimeException(String, int,
   * String, AvaticaSeverity)} with proper contextual information.
   */
  ...
  /**
   * Construct an instance of this exception with the given contextual information surrounding
   * the error.
   *
   ...
   * @param severity An {@link AvaticaSeverity}.
   */
  ...
  /**
   * @return An numeric code for the given error.
   */
  ...
  /**
   * @return The five-character identifier for the given error.
   */
  ...
  /**
   * @return The severity at which this exception is thrown.
   */
