...
import org.apache.avatica.ConnectionProperty.Type;

import java.util.Map;

/**
 * Definitions of properties that drive the behavior of
 * {@link org.apache.avatica.AvaticaDatabaseMetaData}.
 */
public enum InternalProperty {
  ...
  private InternalProperty(Type type,
      Class enumClass, Object defaultValue) {
    this.type = type;
