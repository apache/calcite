...
public class SqlOperatorTest {
     ...
     */
    private static final UnaryOperator<String> DOUBLER = new UnaryOperator<String>() {
    ...
    void testSqlOperatorOverloading() {
        ...
        for (SqlOperator sqlOperator : operatorTable.getOperatorList()) {
            ...
            final SqlIdentifier id = new SqlIdentifier(operatorName, SqlParserPos.ZERO);
    ...
    void testCastDateTime() {
        ...
        final String today = new SimpleDateFormat("yyyy-MM-dd", Locale.ROOT).format(
    ...
    void testCase() {
        ...
        final SqlOperatorFixture f2 = f.withConformance(SqlConformanceEnum.PRAGMATIC_2003);
    ...
    void testNullOperand() {
        ...
        final SqlOperatorFixture f1 = f.withConformance(SqlConformanceEnum.ORACLE_10);
        checkNullOperand(f1, "<>");
    }
    ...
    void testSimilarToOperator() {
        ...
        final String expectedError = TestUtil.getJavaMajorVersion() >= 13
    ...
    SubFunChecker substringChecker(SqlConformanceEnum conformance,
        ...
        return new SubFunChecker(
                f.withConnectionFactory(cf -> cf.with(ConnectionFactories.add(CalciteAssert.SchemaSpec.HR))
    ...
    static class SubFunChecker {
        ...
        void assertSubFunReturns(boolean binary, String s, int start,
            ...
            final String v = binary
                    ? "x'" + DOUBLER.apply(s) + "'"
                    : "'" + s + "'";
            final String type = (binary ? "VARBINARY" : "VARCHAR") + "(" + s.length() + ")";
    ...
    void testExtractIntervalYearMonth() {
        ...
        // Postgres doesn't support DOW, ISODOW, DOY and WEEK on INTERVAL YEAR MONTH
        // type.
    ...
    void testMapValueConstructor() {
        ...
        final SqlOperatorFixture f1 = f.withConformance(SqlConformanceEnum.PRAGMATIC_2003);
     ...
     *
     * <p>
     * Nevertheless the log messages conceal many problems which potentially
     ...
     *
     * <p>
     * Sounds peculiar, but is necessary when eager and lazy behaviors are
     * both valid.
     */
    ...
    protected static class TesterImpl extends SqlRuntimeTester {
        ...
        @Override
        public void check(SqlTestFactory factory, String query,
            ...
            final ConnectionFactory connectionFactory = factory.connectionFactory;
