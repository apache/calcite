...
/**
 * Connection wrapper that returns wrapped Statements and PreparedStatements.
 * This ensures that all ResultSets get wrapped with timezone compensation.
 */
public class FileConnectionWrapper implements Connection {
  private final Connection delegate;
  
  public FileConnectionWrapper(Connection delegate) {
  ...
  public Statement createStatement() throws SQLException {
    ...
    return new FileStatementWrapper(statement);
  }
  ...
  // Wrap PreparedStatement creation methods
  @Override
  public PreparedStatement prepareStatement(String sql) throws SQLException {
    PreparedStatement statement = delegate.prepareStatement(sql);
    return new FilePreparedStatementWrapper(statement);
  }
