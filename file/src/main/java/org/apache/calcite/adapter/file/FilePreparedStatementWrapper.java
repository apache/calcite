...
/**
 * PreparedStatement wrapper that returns wrapped ResultSets.
 */
public class FilePreparedStatementWrapper extends FileStatementWrapper implements PreparedStatement {
  private final PreparedStatement preparedDelegate;
  
  public FilePreparedStatementWrapper(PreparedStatement delegate) {
    super(delegate);
  ...
  // Delegate all PreparedStatement-specific methods
  @Override
