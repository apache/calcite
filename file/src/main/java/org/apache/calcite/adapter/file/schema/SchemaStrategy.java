...
public class SchemaStrategy {
  ...
  public static final SchemaStrategy PARQUET_DEFAULT = new SchemaStrategy(
      ParquetStrategy.LATEST_SCHEMA_WINS,
      CsvStrategy.RICHEST_FILE,
      JsonStrategy.LATEST_FILE
  );
  
  public static final SchemaStrategy CONSERVATIVE = new SchemaStrategy(
      ParquetStrategy.LATEST_FILE,
      CsvStrategy.RICHEST_FILE, 
      JsonStrategy.LATEST_FILE
  );
  
  public static final SchemaStrategy AGGRESSIVE_UNION = new SchemaStrategy(
      ParquetStrategy.UNION_ALL_COLUMNS,
