...
public class StorageProviderSource implements Source {
  ...
  public Source append(Source child) {
    ...
    StorageProvider.FileEntry newEntry = new StorageProvider.FileEntry(
        combinedPath, 
  ...
  public Source relative(Source source) {
    ...
    if (thisPath.startsWith(basePath)) {
      ...
      StorageProvider.FileEntry relativeEntry = new StorageProvider.FileEntry(
          relativePath,
          fileEntry.getName(),
  ...
  public Source trim(String suffix) {
    ...
    if (path.endsWith(suffix)) {
      ...
      StorageProvider.FileEntry trimmedEntry = new StorageProvider.FileEntry(
          trimmedPath,
          trimmedName,
          fileEntry.isDirectory(),
          fileEntry.getSize(),
