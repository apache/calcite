...
/**
 * Enhanced file reader that uses storage providers for accessing various file sources.
 * Supports HTML table extraction from files accessed via different storage systems.
 */
public class FileReaderV2 implements Iterable<Elements> {
  ...
  public FileReaderV2(Source source, @Nullable String selector,
  ...
  public FileReaderV2(Source source) {
