...
public class ParquetFileTest {
  ...
  private void createTestParquetFile(File parquetFile) throws Exception {
    ...
    System.out.println("Created test Parquet file: " + parquetFile.getAbsolutePath());
  }
  ...
  @Test public void testQueryParquetFileDirectly() throws Exception {
    ...
    try (Connection connection = DriverManager.getConnection("jdbc:calcite:");
      ...
      try (Statement stmt = connection.createStatement()) {
        ...
        System.out.println("\n   ✓ Successfully queried Parquet file with " + rowCount + " rows!");
  ...
  @Test public void testParquetFileWithExplicitFormat() throws Exception {
    ...
    try (Connection connection = DriverManager.getConnection("jdbc:calcite:");
      ...
      tableMapping.put("url", new File(tempDir.toFile(), "employees.parquet").getAbsolutePath());
      ...
      try (Statement stmt = connection.createStatement()) {
        ...
        ResultSet rs =
            stmt.executeQuery("SELECT * FROM PARQUET_EXPLICIT.\"EMP_DATA\" WHERE \"salary\" > 100000 ORDER BY \"salary\" DESC");
