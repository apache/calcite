...
public class GeodeAllDataTypesTest extends AbstractGeodeTest {
  ...
  public void testSqlSingleDateWhereFilter() {
    calciteAssert()
        .query("SELECT dateValue "
            + "FROM geode.allDataTypesRegion WHERE dateValue = DATE '2018-02-03'")
        .returnsCount(1)
        .queryContains(
            GeodeAssertions.query("SELECT dateValue AS dateValue FROM /allDataTypesRegion "
  ...
  public void testSqlSingleTimeWhereFilter() {
    calciteAssert()
        .query("SELECT timeValue "
            + "FROM geode.allDataTypesRegion WHERE timeValue = TIME '02:22:23'")
        .returnsCount(1)
        .queryContains(
            GeodeAssertions.query("SELECT timeValue AS timeValue FROM /allDataTypesRegion "
  ...
  public void testSqlSingleTimestampWhereFilter() {
    calciteAssert()
        .query("SELECT timestampValue "
            + "FROM geode.allDataTypesRegion WHERE timestampValue = TIMESTAMP '2018-02-03 02:22:33'")
        .returnsCount(1)
        .queryContains(
    ...
    calciteAssert()
        .query("SELECT timestampValue "
            + "FROM geode.allDataTypesRegion WHERE "
            + "timestampValue < TIMESTAMP '2018-02-03 02:22:33'")
        .returnsCount(0)
        .queryContains(
            GeodeAssertions.query("SELECT timestampValue AS timestampValue "
                + "FROM /allDataTypesRegion "
  ...
  public void testSqlMultipleDateWhereFilter() {
    calciteAssert()
        .query("SELECT dateValue "
            + "FROM geode.allDataTypesRegion WHERE dateValue = DATE '2018-02-03' OR "
            + "dateValue = DATE '2018-02-04'")
        .returnsCount(2)
        .queryContains(
            GeodeAssertions.query("SELECT dateValue AS dateValue FROM /allDataTypesRegion "
                + "WHERE dateValue IN SET(DATE '2018-02-03', DATE '2018-02-04')"));
  }
  ...
  public void testSqlMultipleTimeWhereFilter() {
    calciteAssert()
        .query("SELECT timeValue "
            + "FROM geode.allDataTypesRegion WHERE timeValue = TIME '02:22:23' OR "
            + "timeValue = TIME '03:22:23'")
        .returnsCount(2)
        .queryContains(
            GeodeAssertions.query("SELECT timeValue AS timeValue FROM /allDataTypesRegion "
  ...
  public void testSqlMultipleTimestampWhereFilter() {
    calciteAssert()
        .query("SELECT timestampValue "
            + "FROM geode.allDataTypesRegion WHERE "
            + "timestampValue = TIMESTAMP '2018-02-03 02:22:33' OR "
            + "timestampValue = TIMESTAMP '2018-02-05 04:22:33'")
        .returnsCount(2)
        .queryContains(
            GeodeAssertions.query("SELECT timestampValue AS "
                + "timestampValue FROM /allDataTypesRegion "
                + "WHERE timestampValue IN SET(TIMESTAMP '2018-02-03 02:22:33', "
