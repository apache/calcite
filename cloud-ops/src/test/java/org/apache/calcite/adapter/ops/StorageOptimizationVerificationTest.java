...
public class StorageOptimizationVerificationTest {
  ...
  @Test @DisplayName("Should identify minimal projection for basic listing query")
  ...
  @Test @DisplayName("Should identify security-focused projection")
  ...
  @Test @DisplayName("Should handle SELECT * projection")
  ...
  @Test @DisplayName("Should correctly project rows based on projection")
  ...
  @Test @DisplayName("Should apply pagination limits")
  ...
  @Test @DisplayName("Should calculate API call reduction correctly")
  ...
  @Test @DisplayName("Should identify which API calls are needed based on projection")
