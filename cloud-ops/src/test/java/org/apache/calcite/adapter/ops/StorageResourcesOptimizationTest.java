...
public class StorageResourcesOptimizationTest {
  ...
  void setUp() {
    ...
    CloudOpsConfig.AWSConfig awsConfig =
        new CloudOpsConfig.AWSConfig(Arrays.asList("123456789012"),
        "us-west-2",
        "test-access-key",
        "test-secret-key",
        null);
    ...
    config =
        new CloudOpsConfig(Arrays.asList("aws"),
        null,
        null,
        awsConfig,
  ...
  @Test @DisplayName("Projection handler should identify when minimal columns are needed")
  ...
  @Test @DisplayName("Projection handler should recognize SELECT * queries")
  ...
  @Test @DisplayName("Projection handler should identify encryption columns")
  ...
  @Test @DisplayName("Pagination handler should apply limits correctly")
  ...
  @Test @DisplayName("Storage table should have correct schema")
  ...
  @Test @DisplayName("Projection should handle null and missing values gracefully")
  ...
  @Test @DisplayName("AWS provider configuration should be correct")
