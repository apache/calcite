...
public class SimplePaginationTest {
  ...
  void testBasicPaginationLogic() {
    ...
    RexNode offsetNode = rexBuilder.makeLiteral(BigDecimal.valueOf(5), 
        typeFactory.createSqlType(SqlTypeName.INTEGER), true);
    RexNode limitNode2 = rexBuilder.makeLiteral(BigDecimal.valueOf(3), 
        typeFactory.createSqlType(SqlTypeName.INTEGER), true);
  ...
  @Test
  void testPaginationStrategies() {
    System.out.println("=== Testing Pagination Strategies ===\n");
    
    RexNode offsetNode = rexBuilder.makeLiteral(BigDecimal.valueOf(10), 
        typeFactory.createSqlType(SqlTypeName.INTEGER), true);
