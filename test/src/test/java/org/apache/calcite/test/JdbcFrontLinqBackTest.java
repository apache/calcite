...
public class JdbcFrontLinqBackTest {
  ...
  @Test public void testInsert() {
    final List<HrSchema.Employee> employees = new ArrayList<>();
  ...
  private CalciteAssert.AssertThat mutable(
      final List<HrSchema.Employee> employees) {
    employees.add(new HrSchema.Employee(0, 0, "first", 0f, null));
    return that()
    ...
    return new AbstractModifiableTable(tableName) {
      public RelDataType getRowType(
        ...
        return ((JavaTypeFactory) typeFactory)
            .createType(HrSchema.Employee.class);
      }
      ...
      public Type getElementType() {
        return HrSchema.Employee.class;
      }
