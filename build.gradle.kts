...
val nullawayProjects = listOf(":linq4j", ":core", ":server", ":druid", ":file", ":kafka", ":spark")
...
val adaptersForSqlline = listOf(
    ":arrow", ":babel", ":cassandra", ":druid", ":elasticsearch", "example:csv",
...
// when using the option to build and run tests using Intellij IDEA instead of Gradle
    ...
    plugins.withType<JavaPlugin> {
        ...
        tasks {
            ...
            configureEach<Test> {
                ...
                systemProperty("calcite.model.classes.allowed", "org.,java.lang.")
