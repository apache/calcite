    ...
    plugins.withType<JavaPlugin> {
        ...
        if (enableCheckerframework) {
            ...
            configure<org.checkerframework.gradle.plugin.CheckerFrameworkExtension> {
                ...
                extraJavacArgs.add("-AsuppressWarnings=toArray.nullable.elements.mismatched.size,toArray.nullable.elements.not.newarray")
        ...
        tasks {
            ...
            configureEach<Test> {
                ...
                // For better test coverage field index access should be enabled.
                passProperty("calcite.enable.enumerable.fieldIndexAccess", "true")
