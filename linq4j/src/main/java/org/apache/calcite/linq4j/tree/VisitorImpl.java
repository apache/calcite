...
public class VisitorImpl<R extends @Nullable Object> implements Visitor<R> {
  public VisitorImpl() {
    super();
  }

  @Override public @Nullable R visit(BinaryExpression binaryExpression) {
    R r0 = binaryExpression.expression0.accept(this);
    R r1 = binaryExpression.expression1.accept(this);
    return r1;
  }

  @Override public @Nullable R visit(BlockStatement blockStatement) {
    return Expressions.acceptNodes(blockStatement.statements, this);
  }

  @Override public @Nullable R visit(ClassDeclaration classDeclaration) {
    return Expressions.acceptNodes(classDeclaration.memberDeclarations, this);
  }

  @Override public @Nullable R visit(ConditionalExpression conditionalExpression) {
    return Expressions.acceptNodes(conditionalExpression.expressionList, this);
  }

  @Override public @Nullable R visit(ConditionalStatement conditionalStatement) {
    return Expressions.acceptNodes(conditionalStatement.expressionList, this);
  }

  @Override public @Nullable R visit(ConstantExpression constantExpression) {
    return null;
  }

  @Override public @Nullable R visit(ConstructorDeclaration constructorDeclaration) {
    R r0 = Expressions.acceptNodes(constructorDeclaration.parameters, this);
    return constructorDeclaration.body.accept(this);
  }

  @Override public @Nullable R visit(DeclarationStatement declarationStatement) {
  ...
  @Override public @Nullable R visit(DefaultExpression defaultExpression) {
    return null;
  }

  @Override public @Nullable R visit(DynamicExpression dynamicExpression) {
    return null;
  }

  @Override public @Nullable R visit(FieldDeclaration fieldDeclaration) {
  ...
  @Override public @Nullable R visit(ForStatement forStatement) {
  ...
  @Override public @Nullable R visit(ForEachStatement forEachStatement) {
  ...
  @Override public @Nullable R visit(FunctionExpression functionExpression) {
  ...
  @Override public @Nullable R visit(GotoStatement gotoStatement) {
    return gotoStatement.expression == null ? null
        : gotoStatement.expression.accept(this);
  }

  @Override public @Nullable R visit(IndexExpression indexExpression) {
    R r0 = indexExpression.array.accept(this);
    return Expressions.acceptNodes(indexExpression.indexExpressions, this);
  }

  @Override public @Nullable R visit(InvocationExpression invocationExpression) {
    return null;
  }

  @Override public @Nullable R visit(LabelStatement labelStatement) {
    return labelStatement.defaultValue.accept(this);
  }

  @Override public @Nullable R visit(LambdaExpression lambdaExpression) {
    return null;
  }

  @Override public @Nullable R visit(ListInitExpression listInitExpression) {
    return null;
  }

  @Override public @Nullable R visit(MemberExpression memberExpression) {
    R r = null;
  ...
  @Override public @Nullable R visit(MemberInitExpression memberInitExpression) {
    return null;
  }

  @Override public @Nullable R visit(MethodCallExpression methodCallExpression) {
    R r = null;
  ...
  @Override public @Nullable R visit(MethodDeclaration methodDeclaration) {
    R r0 = Expressions.acceptNodes(methodDeclaration.parameters, this);
    return methodDeclaration.body.accept(this);
  }

  @Override public @Nullable R visit(NewArrayExpression newArrayExpression) {
    R r = null;
  ...
  @Override public @Nullable R visit(NewExpression newExpression) {
  ...
  @Override public @Nullable R visit(ParameterExpression parameterExpression) {
    return null;
  }

  @Override public @Nullable R visit(SwitchStatement switchStatement) {
    return null;
  }

  @Override public @Nullable R visit(TernaryExpression ternaryExpression) {
  ...
  @Override public @Nullable R visit(ThrowStatement throwStatement) {
    return throwStatement.expression.accept(this);
  }

  @Override public @Nullable R visit(TryStatement tryStatement) {
  ...
  @Override public @Nullable R visit(TypeBinaryExpression typeBinaryExpression) {
    return typeBinaryExpression.expression.accept(this);
  }

  @Override public @Nullable R visit(UnaryExpression unaryExpression) {
    return unaryExpression.expression.accept(this);
  }

  @Override public @Nullable R visit(WhileStatement whileStatement) {
