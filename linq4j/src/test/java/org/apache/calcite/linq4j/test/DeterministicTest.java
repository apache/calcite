  ...
  @Test public void testFactorOutBinaryAddNameCollision() {
    assertThat(
        ...
        equalTo("{\n"
            ...
            + "\n"
            + "      });\n"
            + "      static final com.google.common.base.Supplier<Integer> $L4J$C$1_20 = com.google.common.base.Suppliers.memoize(new com.google.common.base.Supplier<Integer>(){\n"
            + "        public Integer get() {\n"
            + "          return 1 - 2;\n"
            + "        }\n"
            + "\n"
  ...
  @Test public void testFactorOutNestedClasses() {
    assertThat(
        ...
        equalTo("{\n"
            ...
            + "      }\n"
            + "\n"
            + "      static final com.google.common.base.Supplier<Integer> $L4J$C$1_4 = com.google.common.base.Suppliers.memoize(new com.google.common.base.Supplier<Integer>(){\n"
            + "        public Integer get() {\n"
            + "          return 1 + 4;\n"
            + "        }\n"
            + "\n"
  ...
  @Test public void testStaticField() {
    ...
    assertThat(
        ...
        equalTo("{\n"
            ...
            + "      }\n"
            + "\n"
            + "      static final com.google.common.base.Supplier<java.math.BigInteger> $L4J$C$java_math_BigInteger_valueOf_42L_ = com.google.common.base.Suppliers.memoize(new com.google.common.base.Supplier<java.math.BigInteger>(){\n"
            + "        public java.math.BigInteger get() {\n"
