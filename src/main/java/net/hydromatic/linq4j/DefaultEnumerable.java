...
public abstract class DefaultEnumerable<T> implements OrderedEnumerable<T> {
    ...
    public <TKey> OrderedEnumerable<T> createOrderedEnumerable(
        ...
        boolean descending)
    {
        return EnumerableDefaults.createOrderedEnumerable(
    ...
    {
        return EnumerableDefaults.groupJoin(
            getThis(),
            inner,
            outerKeySelector,
            innerKeySelector,
    ...
    {
        return EnumerableDefaults.join(
            getThis(),
            inner,
            outerKeySelector,
            innerKeySelector,
    ...
    public <TKey> Enumerable<T> orderByDescending(
        Function1<T, TKey> keySelector, Comparator<TKey> comparator)
    {
        return EnumerableDefaults.orderByDescending(
            getThis(),
            keySelector,
            comparator);
    }
    ...
    {
        return EnumerableDefaults.selectMany(
    ...
    public boolean sequenceEqual(
        ...
        EqualityComparer<T> comparer)
    {
        return EnumerableDefaults.sequenceEqual(
            getThis(),
            enumerable1,
            comparer);
    }
    ...
    public <TKey> OrderedEnumerable<T> thenByDescending(
        ...
        Comparator<TKey> comparator)
    {
        return EnumerableDefaults.thenBy(
            getThisOrdered(),
            keySelector,
            comparator);
    }
    ...
    public <TKey, TElement> Map<TKey, TElement> toMap(
        ...
        Function1<T, TElement> elementSelector)
    {
        return EnumerableDefaults.toMap(
            getThis(), keySelector, elementSelector);
    }
    ...
    public <TKey, TElement> Lookup<TKey, TElement> toLookup(
        ...
        Function1<T, TElement> elementSelector)
    {
        return EnumerableDefaults.toLookup(
            getThis(),
            keySelector,
            elementSelector);
    }
