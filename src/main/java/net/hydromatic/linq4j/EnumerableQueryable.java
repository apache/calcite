    ...
    implements Queryable<T>
{
    ...
    {
        return EnumerableDefaults.union(
            getThis(), source1, comparer).asQueryable();
    }
    ...
    public Queryable<T> intersect(
        Enumerable<T> source1, EqualityComparer<T> comparer)
    {
        return EnumerableDefaults.intersect(
            getThis(), source1, comparer).asQueryable();
    }
    ...
    {
        return EnumerableDefaults.aggregate(
            getThis(),
            seed,
    ...
    public T firstOrDefault(FunctionExpression<Predicate1<T>> predicate) {
        return EnumerableDefaults.firstOrDefault(
            getThis(),
    ...
    public T lastOrDefault(FunctionExpression<Predicate1<T>> predicate) {
        return EnumerableDefaults.lastOrDefault(
            getThis(),
            predicate.getFunction());
    }
    ...
    {
        return EnumerableDefaults.asOrderedQueryable(
            EnumerableDefaults.orderByDescending(
    ...
    public T singleOrDefault(FunctionExpression<Predicate1<T>> predicate) {
        return EnumerableDefaults.singleOrDefault(
            getThis(),
            predicate.getFunction());
    }
