...
public interface Enumerator<T> {
     ...
     *
     * @throws java.util.ConcurrentModificationException if collection has
     * been modified
     *
     * @throws java.util.NoSuchElementException if {@code moveToNext} has not
     ...
     * next element; {@code false} if the enumerator has passed the end of the
     * collection
     */
    boolean moveNext();
