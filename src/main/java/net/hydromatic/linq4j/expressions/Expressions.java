...
public class Expressions {
     ...
     * VisitMethodCall. */
    public static MethodCallExpression accept(ExpressionVisitor visitor) { throw Extensions.todo(); }
    ...
    public static BinaryExpression add(Expression expression0, Expression expression1, Method method) { throw Extensions.todo(); }
    ...
    /** Creates a BinaryExpression that represents an addition
     * assignment operation that does not have overflow checking. */
    public static BinaryExpression addAssign(Expression expression0, Expression expression1, Method method) { throw Extensions.todo(); }

    /** Creates a BinaryExpression that represents an addition
     * assignment operation that does not have overflow checking. */
    public static BinaryExpression addAssign(Expression expression0, Expression expression1, Method method, LambdaExpression lambdaExpression0, LambdaExpression lambdaExpression1) { throw Extensions.todo(); }
    ...
    /** Creates a BinaryExpression that represents an addition
     * assignment operation that has overflow checking. */
    public static BinaryExpression addAssignChecked(Expression expression0, Expression expression1, Method method) { throw Extensions.todo(); }

    /** Creates a BinaryExpression that represents an addition
     * assignment operation that has overflow checking. */
    public static BinaryExpression addAssignChecked(Expression expression0, Expression expression1, Method method, LambdaExpression lambdaExpression) { throw Extensions.todo(); }

    /** Creates a BinaryExpression that represents an arithmetic
     * addition operation that has overflow checking. */
    public static BinaryExpression addChecked(Expression expression0, Expression expression1) { throw Extensions.todo(); }

    /** Creates a BinaryExpression that represents an arithmetic
     * addition operation that has overflow checking. The implementing
     * method can be specified. */
    public static BinaryExpression addChecked(Expression expression0, Expression expression1, Method method) { throw Extensions.todo(); }
     ...
     * array. */
    public static IndexExpression arrayAccess(Expression array, Iterable<Expression> indexExpressions) { throw Extensions.todo(); }

    /** Creates an IndexExpression to access an array. */
    public static IndexExpression arrayAccess(Expression array, Expression indexExpressions[]) { throw Extensions.todo(); }

    /** Creates a MethodCallExpression that represents applying an
     * array index operator to an array of rank more than one. */
    public static MethodCallExpression arrayIndex(Expression array, Iterable<Expression> indexExpressions) { throw Extensions.todo(); }
    ...
    public static MethodCallExpression arrayIndex(Expression array, Expression indexExpressions[]) { throw Extensions.todo(); }
    ...
    public static MemberAssignment bind(Member member, Expression right) { throw Extensions.todo(); }

    /** Creates a MemberAssignment that represents the initialization
     * of a member by using a property accessor method. */
    public static MemberAssignment bind(Method method, Expression expression) { throw Extensions.todo(); }

    /** Creates a BlockExpression that contains the given expressions
     * and has no variables. */
    public static BlockExpression block(Expression[] expressions) { throw Extensions.todo(); }

    /** Creates a BlockExpression that contains the given expressions
     * and has no variables. */
    public static BlockExpression block(Iterable<Expression> expressions) { throw Extensions.todo(); }
     ...
     * and expressions. */
    public static BlockExpression block(Iterable<ParameterExpression> variables, Iterable<Expression> expressions) { throw Extensions.todo(); }
     ...
     * has no variables. */
    public static BlockExpression block(Expression expression0, Expression expression1, Expression expression2) { throw Extensions.todo(); }
     ...
     * has no variables. */
    public static BlockExpression block(Expression expression0, Expression expression1, Expression expression2, Expression expression3) { throw Extensions.todo(); }
    ...
    public static MethodCallExpression call(Method method, Iterable<Expression> expressions) { throw Extensions.todo(); }
    ...
    public static MethodCallExpression call(Method method, Expression[] expressions) { throw Extensions.todo(); }
    ...
    public static MethodCallExpression call(Class clazz, String methodName, Class[] typeArguments, Expression[] arguments) { throw Extensions.todo(); }
     ...
     * statement. */
    public static ConditionalExpression condition(Expression expression0, Expression expression1, Expression expression2) { throw Extensions.todo(); }

    /** Creates a ConditionalExpression that represents a conditional
     * statement. */
    public static ConditionalExpression condition(Expression expression0, Expression expression1, Expression expression2, Class clazz) { throw Extensions.todo(); }
     ...
     * operation. */
    public static UnaryExpression convert_(Expression expression, Class clazz) { throw Extensions.todo(); }

    /** Creates a UnaryExpression that represents a conversion
     * operation for which the implementing method is specified. */
    public static UnaryExpression convert_(Expression expression, Class type, Method method) { throw Extensions.todo(); }

    /** Creates a UnaryExpression that represents a conversion
     * operation that throws an exception if the target type is
     * overflowed. */
    public static UnaryExpression convertChecked(Expression expression, Class type) { throw Extensions.todo(); }

    /** Creates a UnaryExpression that represents a conversion
     * operation that throws an exception if the target type is
     * overflowed and for which the implementing method is
     * specified. */
    public static UnaryExpression convertChecked_(Expression expression, Class type, Method method) { throw Extensions.todo(); }
    ...
    /** Creates a DynamicExpression that represents a dynamic
     * operation bound by the provided CallSiteBinder. */
    public static DynamicExpression dynamic(CallSiteBinder binary, Class type, Expression expression0, Expression expression1) { throw Extensions.todo(); }

    /** Creates a DynamicExpression that represents a dynamic
     * operation bound by the provided CallSiteBinder. */
    public static DynamicExpression dynamic(CallSiteBinder binary, Class type, Expression expression0, Expression expression1, Expression expression2) { throw Extensions.todo(); }
    ...
    public static MemberExpression field(Expression expression, String fieldName) { throw Extensions.todo(); }
    ...
    public static Class getActionType(Class[] typeArgs) { throw Extensions.todo(); }

    /** Gets a Type object that represents a generic System.Func or
     * System.Action delegate type that has specific type
     * arguments. */
    public static Class getDelegateType(Class[] typeArgs) { throw Extensions.todo(); }
    ...
    public static Class getFuncType(Class[] typeArgs) { throw Extensions.todo(); }
    ...
    /** Creates a BinaryExpression that represents a "greater than or
     * equal" numeric comparison. */
    public static BinaryExpression greaterThanOrEqual(Expression expression0, Expression expression1, boolean liftToNull, Method method) { throw Extensions.todo(); }

    /** Creates a ConditionalExpression that represents a conditional
     * block with an if statement. */
    public static ConditionalExpression ifThen(Expression test, Expression ifTrue) { throw Extensions.todo(); }

    /** Creates a ConditionalExpression that represents a conditional
     * block with if and else statements. */
    public static ConditionalExpression ifThenElse(Expression test, Expression ifTrue, Expression ifFalse) { throw Extensions.todo(); }
    ...
    /** Creates a UnaryExpression that represents the incrementing of
     * the expression by 1. */
    public static UnaryExpression increment(Expression expression, Method method) { throw Extensions.todo(); }
     ...
     * type. */
    public static LabelTarget label(Class type) { throw Extensions.todo(); }
     ...
     * and name. */
    public static LabelTarget label(Class type, String name) { throw Extensions.todo(); }

    /** Creates a LambdaExpression by first constructing a delegate
     * type. */
    public static LambdaExpression lambda(Expression body, Iterable<ParameterExpression> parameters) { throw Extensions.todo(); }

    /** Creates a LambdaExpression by first constructing a delegate
     * type. */
    public static LambdaExpression Lambda(Expression body, ParameterExpression[] parameters) { throw Extensions.todo(); }

    /** Creates a LambdaExpression by first constructing a delegate
     * type. */
    public static LambdaExpression lambdaE(Expression body, boolean tailCall, Iterable<ParameterExpression> parameters) { throw Extensions.todo(); }

    /** Creates a LambdaExpression by first constructing a delegate
     * type. */
    public static LambdaExpression lambda(Expression body, boolean tailCall, ParameterExpression[] parameters) { throw Extensions.todo(); }

    /** Creates a LambdaExpression by first constructing a delegate
     * type. */
    public static LambdaExpression lambdaE(Expression body, String name, Iterable<ParameterExpression> parameters) { throw Extensions.todo(); }
     ...
     * type. It can be used when the delegate type is not known at
     * compile time. */
    public static LambdaExpression lambda(Class type, Expression body, ParameterExpression[] parameters) { throw Extensions.todo(); }

    /** Creates a LambdaExpression by first constructing a delegate
     * type. */
    public static LambdaExpression lambdaE(Expression body, String name, boolean tailCall, Iterable<ParameterExpression> parameters) { throw Extensions.todo(); }

    /** Creates a LambdaExpression by first constructing a delegate
     * type. */
    public static LambdaExpression lambda(Class type, Expression expression, boolean tailCall, Iterable<ParameterExpression> parameters) { throw Extensions.todo(); }

    /** Creates a LambdaExpression by first constructing a delegate
     * type. */
    public static LambdaExpression lambda(Class type, Expression body, boolean tailCall, ParameterExpression[] parameters) { throw Extensions.todo(); }
    ...
    /** Creates a LambdaExpression lambdaExpression by first constructing a delegate
     * type. */
    public static LambdaExpression lambda(Class type, Expression body, String name, boolean tailCall, Iterable<ParameterExpression> parameters) { throw Extensions.todo(); }

    /** Creates an Expression<TDelegate> where the delegate type is
     * known at compile time. */
    public static <TDelegate> FunctionExpression<TDelegate> lambdaE(Expression body, Iterable<ParameterExpression> parameters) { throw Extensions.todo(); }

    /** Creates an Expression<TDelegate> where the delegate type is
     * known at compile time. */
    public static <TDelegate> FunctionExpression<TDelegate> lambda(Expression body, ParameterExpression[] parameters) { throw Extensions.todo(); }

    /** Creates an Expression<TDelegate> where the delegate type is
     * known at compile time. */
    public static <TDelegate> FunctionExpression<TDelegate> lambda(Expression body, boolean tailCall, Iterable<ParameterExpression> parameters) { throw Extensions.todo(); }

    /** Creates an Expression<TDelegate> where the delegate type is
     * known at compile time. */
    public static <TDelegate> FunctionExpression<TDelegate> lambdaT(Expression body, boolean tailCall, ParameterExpression[] parameters) { throw Extensions.todo(); }

    /** Creates an Expression<TDelegate> where the delegate type is
     * known at compile time. */
    public static <TDelegate> FunctionExpression<TDelegate> lambda(Expression body, String name, Iterable<ParameterExpression> parameters) { throw Extensions.todo(); }

    /** Creates an Expression<TDelegate> where the delegate type is
     * known at compile time. */
    public static <TDelegate> FunctionExpression<TDelegate> lambda(Expression body, String name, boolean tailCall, Iterable<ParameterExpression> parameters) { throw Extensions.todo(); }
    ...
    /** Creates a BinaryExpression that represents a bitwise
     * left-shift assignment operation. */
    public static BinaryExpression leftShiftAssign(Expression expression0, Expression expression1, Method method, LambdaExpression lambdaExpression) { throw Extensions.todo(); }

    /** Creates a BinaryExpression that represents a "less than"
     * numeric comparison. */
    public static BinaryExpression lessThan(Expression expression0, Expression expression1) { throw Extensions.todo(); }

    /** Creates a BinaryExpression that represents a "less than"
     * numeric comparison. */
    public static BinaryExpression lessThan(Expression expression0, Expression expression1, boolean liftToNull, Method method) { throw Extensions.todo(); }
    ...
    /** Creates a BinaryExpression that represents a "less than or
     * equal" numeric comparison. */
    public static BinaryExpression lessThanOrEqual(Expression expression0, Expression expression1, boolean liftToNull, Method method) { throw Extensions.todo(); }

    /** Creates a MemberListBinding where the member is a field or
     * property. */
    public static MemberListBinding listBind(Member member, Iterable<ElementInit> elementInits) { throw Extensions.todo(); }

    /** Creates a MemberListBinding where the member is a field or
     * property. */
    public static MemberListBinding listBind(Member member, ElementInit[] elementInits) { throw Extensions.todo(); }
    ...
    public static ListInitExpression listInitE(NewExpression newExpression, Iterable<Expression> arguments) { throw Extensions.todo(); }
    ...
    /** Creates a ListInitExpression that uses a method named "Add" to
     * add elements to a collection. */
    public static ListInitExpression listInit(NewExpression newExpression, Expression[] arguments) { throw Extensions.todo(); }

    /** Creates a ListInitExpression that uses a specified method to
     * add elements to a collection. */
    public static ListInitExpression listInit(NewExpression newExpression, Method method, Iterable<Expression> arguments) { throw Extensions.todo(); }

    /** Creates a ListInitExpression that uses a specified method to
     * add elements to a collection. */
    public static ListInitExpression listInit(NewExpression newExpression, Method method, Expression[] arguments) { throw Extensions.todo(); }
     ...
     * target. */
    public static LoopExpression loop(Expression body, LabelTarget breakTarget) { throw Extensions.todo(); }

    /** Creates a LoopExpression with the given body. */
    public static LoopExpression loop(Expression body, LabelTarget breakTarget, LabelTarget continueTarget) { throw Extensions.todo(); }
    ...
    /** Creates a DynamicExpression that represents a dynamic
     * operation bound by the provided CallSiteBinder. */
    public static DynamicExpression makeDynamic(Class type, CallSiteBinder binder, Iterable<Expression> arguments) { throw Extensions.todo(); }

    /** Creates a DynamicExpression that represents a dynamic
     * operation bound by the provided CallSiteBinder and one
     * argument. */
    public static DynamicExpression makeDynamic(Class type, CallSiteBinder binder, Expression argument) { throw Extensions.todo(); }

    /** Creates a DynamicExpression that represents a dynamic
     * operation bound by the provided CallSiteBinder. */
    public static DynamicExpression MakeDynamic(Class type, CallSiteBinder binder, Expression[] arguments) { throw Extensions.todo(); }

    /** Creates a DynamicExpression that represents a dynamic
     * operation bound by the provided CallSiteBinder and two
     * arguments. */
    public static DynamicExpression makeDynamic(Class type, CallSiteBinder binder, Expression expression0, Expression expression1) { throw Extensions.todo(); }

    /** Creates a DynamicExpression that represents a dynamic
     * operation bound by the provided CallSiteBinder and three
     * arguments. */
    public static DynamicExpression makeDynamic(Class type, CallSiteBinder binder, Expression expression0, Expression expression1, Expression expression2) { throw Extensions.todo(); }

    /** Creates a DynamicExpression that represents a dynamic
     * operation bound by the provided CallSiteBinder and four
     * arguments. */
    public static DynamicExpression makeDynamic(Class type, CallSiteBinder binder, Expression expression0, Expression expression1, Expression expression2, Expression expression3) { throw Extensions.todo(); }
     ...
     * field or a property. */
    public static MemberExpression makeMemberAccess(Expression expression, Member member) { throw Extensions.todo(); }
     ...
     * appropriate factory method. */
    public static UnaryExpression makeUnary(ExpressionType expressionType, Expression expression, Class type) { throw Extensions.todo(); }

    /** Creates a UnaryExpression, given an operand and implementing
     * method, by calling the appropriate factory method. */
    public static UnaryExpression makeUnary(ExpressionType expressionType, Expression expression, Class type, Method method) { assert type != null; throw Extensions.todo(); }
    ...
    public static MemberInitExpression memberInit(NewExpression newExpression, Iterable<MemberBinding> bindings) { throw Extensions.todo(); }
    ...
    private static boolean shouldLift(Expression expression0, Expression expression1, Method method) {
     ...
     * multiplication operation that does not have overflow
     * checking. */
    public static BinaryExpression multiply(Expression expression0, Expression expression1, Method method) {
        return makeBinary(
    ...
    /** Creates a BinaryExpression that represents a multiplication
     * assignment operation that does not have overflow checking. */
    public static BinaryExpression multiplyAssign(Expression expression0, Expression expression1, Method method, LambdaExpression lambdaExpression)  {
    ...
    /** Creates a BinaryExpression that represents a multiplication
     * assignment operation that has overflow checking. */
    public static BinaryExpression multiplyAssignChecked(Expression expression0, Expression expression1, Method method, LambdaExpression lambdaExpression)  {
        return makeBinary(ExpressionType.MultiplyAssignChecked, expression0, expression1, false, method, lambdaExpression);
    }

    /** Creates a BinaryExpression that represents an arithmetic
     * multiplication operation that has overflow checking. */
    public static BinaryExpression MultiplyChecked(Expression expression0, Expression expression1)  {
        return makeBinary(ExpressionType.MultiplyChecked, expression0, expression1);
    }

    /** Creates a BinaryExpression that represents an arithmetic
     * multiplication operation that has overflow checking. */
    public static BinaryExpression MultiplyChecked(Expression expression0, Expression expression1, Method method)  {
        return makeBinary(
    ...
    public static NewArrayExpression newArrayBounds(Class type, Iterable<Expression> expressions) { throw Extensions.todo(); }

    /** Creates a NewArrayExpression that represents creating an array
     * that has a specified rank. */
    public static NewArrayExpression newArrayBounds(Class type, Expression[] expressions) {
    ...
    public static UnaryExpression onesComplement(Expression expression)  {
        return makeUnary(ExpressionType.OnesComplement, expression, expression.getType());
    }
    ...
    /** Creates a BinaryExpression that represents a bitwise OR
     * operation. */
    public static BinaryExpression or(Expression expression0, Expression expression1, Method method) {
     ...
     * operation that evaluates the second operand only if the first
     * operand evaluates to false. */
    public static BinaryExpression orElse(Expression expression0, Expression expression1, Method method)  {
        return makeBinary(ExpressionType.OrElse, expression0, expression1, false, method);
    }
     ...
     * expression. */
    // REVIEW: In Java this is a call to a lib function, Math.pow.
    public static BinaryExpression powerAssign(Expression expression0, Expression expression1, Method method) { throw Extensions.todo(); }
    ...
    public static MemberExpression property(Expression expression, Method method) { throw Extensions.todo(); }

    /** Creates a MemberExpression that represents accessing a
     * property. */
    // REVIEW: No equivalent to properties in Java.
    public static MemberExpression property(Expression expression, PropertyInfo property) { throw Extensions.todo(); }
     ...
     * indexed property. */
    // REVIEW: No equivalent to properties in Java.
    public static IndexExpression property(Expression expression, PropertyInfo property, Iterable<Expression> arguments) { throw Extensions.todo(); }

    /** Creates an IndexExpression representing the access to an
     * indexed property. */
    // REVIEW: No equivalent to properties in Java.
    public static IndexExpression property(Expression expression, PropertyInfo property, Expression[] arguments) { throw Extensions.todo(); }

    /** Creates an IndexExpression representing the access to an
     * indexed property. */
    // REVIEW: No equivalent to properties in Java.
    public static IndexExpression Property(Expression expression, String name, Expression[] arguments) { throw Extensions.todo(); }
    ...
    public static MemberExpression propertyOrField(Expression expression, String propertyOfFieldName) { throw Extensions.todo(); }

    /** Creates a UnaryExpression that represents an expression that
     * has a constant value of type Expression. */
    public static UnaryExpression quote(Expression expression) {
        return makeUnary(ExpressionType.Quote, expression, expression.getType());
    }
     ...
     * exception. */
    public static UnaryExpression rethrow() { throw Extensions.todo(); }
    ...
    public static BinaryExpression rightShift(Expression expression0, Expression expression1)  {
        return makeBinary(ExpressionType.RightShift, expression0, expression1);
    }

    /** Creates a BinaryExpression that represents a bitwise
     * right-shift operation. */
    public static BinaryExpression rightShift(Expression expression0, Expression expression1, Method method) {
        return makeBinary(ExpressionType.RightShift, expression0, expression1, false, method);
    }
    ...
    /** Creates a BinaryExpression that represents a bitwise
     * right-shift assignment operation. */
    public static BinaryExpression rightShiftAssign(Expression expression0, Expression expression1, Method method, LambdaExpression lambdaExpression)  {
        return makeBinary(ExpressionType.RightShiftAssign, expression0, expression1, false, method, lambdaExpression);
    }
    ...
    /** Creates a BinaryExpression that represents a subtraction
     * assignment operation that does not have overflow checking. */
    public static BinaryExpression subtractAssign(Expression expression0, Expression expression1, Method method, LambdaExpression lambdaExpression) {
        return makeBinary(ExpressionType.SubtractAssign, expression0, expression1, false, method, lambdaExpression);
    }
    ...
    /** Creates a BinaryExpression that represents a subtraction
     * assignment operation that has overflow checking. */
    public static BinaryExpression subtractAssignChecked(Expression expression0, Expression expression1, Method method)  {
        return makeBinary(ExpressionType.SubtractAssignChecked, expression0, expression1, false, method);
    }

    /** Creates a BinaryExpression that represents a subtraction
     * assignment operation that has overflow checking. */
    public static BinaryExpression subtractAssignChecked(Expression expression0, Expression expression1, Method method, LambdaExpression lambdaExpression)  {
        return makeBinary(ExpressionType.SubtractAssignChecked, expression0, expression1, false, method, lambdaExpression);
    }

    /** Creates a BinaryExpression that represents an arithmetic
     * subtraction operation that has overflow checking. */
    public static BinaryExpression subtractChecked(Expression expression0, Expression expression1)  {
    ...
    /** Creates a SwitchExpression that represents a switch statement
     * that has a default case. */
    public static SwitchExpression switch_(Expression switchValue, Expression defaultBody, Method method, Iterable<SwitchCase> cases) { throw Extensions.todo(); }
    ...
    /** Creates a SwitchExpression that represents a switch statement
     * that has a default case. */
    public static SwitchExpression switch_(Class type, Expression switchValue, Expression defaultBody, Method method, Iterable<SwitchCase> cases) { throw Extensions.todo(); }
     ...
     * object. */
    public static SwitchCase switchCase(Expression expression, Iterable<Expression> body) { throw Extensions.todo(); }
    ...
    public static SymbolDocumentInfo symbolDocument(String fileName) { throw Extensions.todo(); }

    /** Creates an instance of SymbolDocumentInfo. */
    public static SymbolDocumentInfo symbolDocument(String fileName, UUID language) { throw Extensions.todo(); }

    /** Creates an instance of SymbolDocumentInfo. */
    public static SymbolDocumentInfo symbolDocument(String fileName, UUID language, UUID vendor) { throw Extensions.todo(); }

    /** Creates an instance of SymbolDocumentInfo. */
    public static SymbolDocumentInfo symbolDocument(String filename, UUID language, UUID vendor, UUID documentType) { throw Extensions.todo(); }

    /** Creates a UnaryExpression that represents a throwing of an
     * exception. */
    public static UnaryExpression throw_(Expression expression) { throw Extensions.todo(); }
    ...
    /** Creates a Type object that represents a generic System.Action
     * delegate type that has specific type arguments. */
    public static boolean tryGetActionType(Class[] typeArgs, Class[] outActionType) { throw Extensions.todo(); }

    /** Creates a Type object that represents a generic System.Func
     * delegate type that has specific type arguments. The last type
     * argument specifies the return type of the created delegate. */
    public static boolean tryGetFuncType(Class[] typeArgs, Class[] outFuncType) { throw Extensions.todo(); }
    ...
    public static TypeBinaryExpression typeIs(Expression expression, Class type) { throw Extensions.todo(); }
     ...
     * is not reducible.*/
    public static Expression VisitChildren(ExpressionVisitor visitor) { throw Extensions.todo(); }
