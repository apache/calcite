...
public abstract class EnumerableDefaults {
    ...
    {
        return aggregate(
            source.select(adapt(selector)), null, Extensions.DOUBLE_MAX);
    }
    ...
    {
        return aggregate(
            source.select(adapt(selector)), null, Extensions.INTEGER_MAX);
    }
    ...
    {
        return aggregate(
            source.select(adapt(selector)), null, Extensions.LONG_MAX);
    }
    ...
    {
        return aggregate(
            source.select(adapt(selector)), null, Extensions.FLOAT_MAX);
    }
    ...
    {
        return aggregate(
            source.select(adapt(selector)), null, Extensions.DOUBLE_MIN);
    }
    ...
    {
        return aggregate(
            source.select(adapt(selector)), null, Extensions.INTEGER_MIN);
    }
    ...
    {
        return aggregate(
            source.select(adapt(selector)), null, Extensions.LONG_MIN);
    }
    ...
    {
        return aggregate(
            source.select(adapt(selector)), null, Extensions.FLOAT_MIN);
    }
    ...
    {
        return aggregate(
            source.select(selector), BigDecimal.ZERO,
    ...
    {
        return aggregate(
            source.select(adapt(selector)), 0d, Extensions.DOUBLE_SUM);
    }
    ...
    {
        return aggregate(
            source.select(adapt(selector)), 0, Extensions.INTEGER_SUM);
    }
    ...
    {
        return aggregate(
            source.select(adapt(selector)), 0L, Extensions.LONG_SUM);
    }
    ...
    {
        return aggregate(
            source.select(adapt(selector)), 0F, Extensions.FLOAT_SUM);
    }
    ...
    {
        return createOrderedEnumerable(
            source, keySelector, Extensions.<TKey>comparableComparator(), true);
    }
