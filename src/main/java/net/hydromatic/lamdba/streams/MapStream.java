...
public interface MapStream<K, V> extends Iterable<BiValue<K, V>> {
    ...
    class Impl {
        ...
        public static <K, V> MapStream<K, V> filter(
        ...
        public static <K, V> MapStream<K, V> sorted(
            MapStream<K, V> s, Comparator<? super K> comparator)
        {
        ...
        public static <K, V> boolean anyMatch(
            MapStream<K, V> s, BiPredicate<? super K, ? super V> biPredicate)
        {
            for (BiValue<K, V> each : s.asIterable()) {
        ...
        public static <K, V> MapStream<K, V> filterKeys(
            MapStream<K, V> s,
            final Predicate<K> filter)
        {
            return filter(
                s,
                new BiPredicates.AbstractBiPredicate<K, V>()
                {
        ...
        public static <K, V> MapStream<K, V> filterValues(
            MapStream<K, V> s,
        ...
        public static <K, V, W> MapStream<K, W> mapValues(
            final MapStream<K, V> s,
        ...
        public static <K, V, W> MapStream<K, W> map(
            final MapStream<K, V> s,
        ...
        public static <K, V> MapStream<K, V> merge(
            MapStream<K, V> s,
            MapStream<K, V> other)
        {
    ...
    abstract class AbstractMapStream<K, V> implements MapStream<K, V> {
        ...
        public <A extends Map<? super K, C>,
            C extends Collection<? super V>>
        A intoMulti(
            A destination, Factory<C> factory)
        {
