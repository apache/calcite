...
| m | CONCAT(any [, any ]*)                          | Concatenates one or more strings/bytestrings/..., if arguments contains bytestring would return bytes string and returns null if any of the arguments is null
