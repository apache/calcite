...
| b | CODE_POINTS_TO_BYTES(array&lt;integer&gt;)     | Converts an *array&lt;integer&gt;* of extended ASCII code points to bytes, return null if array is null or the element of the array is null
