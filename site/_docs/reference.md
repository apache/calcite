...
| m | CONCAT(string/bytestring [, string/bytestring ]*)     | Concatenates one or more strings/bytestrings, if arguments contains bytestring would return bytes, otherwise would return string, and return null if any of the arguments is null
