...
| s | string1 RLIKE string2 | Whether *string1* matches regex pattern *string2*. Use RLIKE to match with standard regular expressions.
| s | string1 NOT RLIKE string2 | Whether *string1* does not match regex pattern *string2*. Use RLIKE to match with standard regular expressions.
| h | string1 RLIKE string2 | Whether *string1* matches regex pattern *string2*. Use RLIKE to match with standard regular expressions.
| h | string1 NOT RLIKE string2 | Whether *string1* does not match regex pattern *string2*. Use RLIKE to match with standard regular expressions.
