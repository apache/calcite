...
| * | RIGHTSHIFT(value1, value2)                     | Returns the result of shifting *value1* to the right by *value2* bits. *value1* and *value2* must both be integer or binary values. For binary values,*
