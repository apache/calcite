...
| b o r s | LPAD(string, length [, pattern ])        | Returns a string or bytes value that consists of *string* prepended to *length* with *pattern*
...
| b o r s | LTRIM(string)                            | Returns *string* with all blanks removed from the start
...
| b o r s | RPAD(string, length[, pattern ])         | Returns a string or bytes value that consists of *string* appended to *length* with *pattern*
| b o r s | RTRIM(string)                            | Returns *string* with all blanks removed from the end
