...
| s i | URL_DECODE(string)                           | Decodes a *string* in 'application/x-www-form-urlencoded' format using a specific encoding scheme, returns original *string* when decoded error
| s i | URL_ENCODE(string)                           | Translates a *string* into 'application/x-www-form-urlencoded' format using a specific encoding scheme
