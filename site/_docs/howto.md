...
In the context of Avatica, Protocol Buffers provides the ability
to generate a collection of messages defined by a schema. The library
itself provides the ability to parse old serialized messages using a
