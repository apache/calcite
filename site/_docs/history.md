...
* [<a href="https://issues.apache.org/jira/browse/CALCITE-1931">CALCITE-1931</a>]
  Various aggregate functions that used to return INTEGER now return other types.
  RANK, DENSE_RANK and NTILE now return BIGINT; CUME_DIST and PERCENT_RANK now return DOUBLE.
