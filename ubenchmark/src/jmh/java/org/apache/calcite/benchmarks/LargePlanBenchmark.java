...
public class LargePlanBenchmark {
  ...
  public void testLargeUnionPlan() {
    testLargeUnionPlan(unionNum);
  }

  public void testLargeUnionPlan(int unionNum) {
  ...
  public static void main(String[] args) throws RunnerException {
    ...
    // For painting a flame graph:
//    LargePlanBenchmark lp = new LargePlanBenchmark();
//    lp.setup();
//    lp.isLargePlanMode = false;
//    lp.isEnableFiredRulesCache = true;
//    int[] sizes = {10000};
//    for (int size : sizes) {
//      long startTime = System.currentTimeMillis();
//      lp.testLargeUnionPlan(size);
//      long endTime = System.currentTimeMillis();
//      System.out.println(size + " finished, elapsed time: "
