...
public class SharePointRestAttachmentIntegrationTest {
  ...
  @Test public void testRestClientCreation() {
  ...
  @Test public void testAuthenticationToken() {
    try {
  ...
  @Test public void testGetAttachmentsRest() {
    try {
  ...
  @Test public void testCreateListForAttachments() {
    try {
  ...
  @Test public void testDiscoverSharePointLists() {
    try {
  ...
  @Test public void testListExistingItems() {
    try {
  ...
  @Test public void testUploadAttachmentToNewItem() {
    try {
  ...
  @Test public void testUploadAndDeleteAttachmentRest() {
    try {
  ...
  @Test public void testRestApiEndpoints() {
