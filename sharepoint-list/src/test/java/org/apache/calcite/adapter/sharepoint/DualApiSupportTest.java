...
public class DualApiSupportTest {
  ...
  @Test public void testDirectAuthProviderCreation() {
  ...
  @Test public void testProxyAuthProviderCreation() {
    Map<String, Object> config = new HashMap<>();
    config.put("siteUrl", "https://contoso.sharepoint.com");
  ...
  @Test public void testApiProviderFactoryGraphSelection() {
    Map<String, Object> config = new HashMap<>();
    config.put("siteUrl", "https://contoso.sharepoint.com");
    config.put("tenantId", "test-tenant");
    config.put("clientId", "test-client");
  ...
  @Test public void testApiProviderFactoryRestSelection() {
    Map<String, Object> config = new HashMap<>();
    config.put("siteUrl", "https://contoso.sharepoint.com");
    config.put("tenantId", "test-tenant");
    config.put("clientId", "test-client");
  ...
  @Test public void testApiProviderFactoryOnPremisesDetection() {
    Map<String, Object> config = new HashMap<>();
  ...
  @Test public void testApiProviderFactorySharePointOnlineDetection() {
    Map<String, Object> config = new HashMap<>();
    config.put("siteUrl", "https://contoso.sharepoint.com");
    config.put("tenantId", "test-tenant");
    config.put("clientId", "test-client");
  ...
  @Test public void testLegacyAuthForcesRestApi() {
    Map<String, Object> config = new HashMap<>();
    config.put("siteUrl", "https://contoso.sharepoint.com");
    config.put("tenantId", "test-tenant");
    config.put("clientId", "test-client");
  ...
  @Test public void testPhase2TokenCommandAuth() {
    Map<String, Object> config = new HashMap<>();
    config.put("siteUrl", "https://contoso.sharepoint.com");
  ...
  @Test public void testPhase2TokenFileAuth() {
    Map<String, Object> config = new HashMap<>();
    config.put("siteUrl", "https://contoso.sharepoint.com");
  ...
  @Test public void testPhase2TokenEndpointAuth() {
    Map<String, Object> config = new HashMap<>();
    config.put("siteUrl", "https://contoso.sharepoint.com");
