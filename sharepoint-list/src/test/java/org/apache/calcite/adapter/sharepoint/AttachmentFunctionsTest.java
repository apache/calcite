...
public class AttachmentFunctionsTest {
  ...
  @Test
  public void testGetAttachmentsMethodExists() {
    // Test that the getAttachments method exists with correct signature
    assertDoesNotThrow(() -> {
      Method method = SharePointAttachmentFunctions.class.getMethod(
          "getAttachments", DataContext.class, String.class, String.class);
  ...
  @Test
  public void testAddAttachmentMethodExists() {
    // Test that the addAttachment method exists with correct signature
    assertDoesNotThrow(() -> {
      Method method = SharePointAttachmentFunctions.class.getMethod(
          "addAttachment", DataContext.class, String.class, String.class, String.class, byte[].class);
      assertNotNull(method);
  ...
  @Test
  public void testDeleteAttachmentMethodExists() {
    // Test that the deleteAttachment method exists with correct signature
    assertDoesNotThrow(() -> {
      Method method = SharePointAttachmentFunctions.class.getMethod(
          "deleteAttachment", DataContext.class, String.class, String.class, String.class);
      assertNotNull(method);
      assertEquals(boolean.class, method.getReturnType());
    });
  }
  ...
  @Test
  public void testGetAttachmentContentMethodExists() {
    // Test that the getAttachmentContent method exists with correct signature
    assertDoesNotThrow(() -> {
      Method method = SharePointAttachmentFunctions.class.getMethod(
          "getAttachmentContent", DataContext.class, String.class, String.class, String.class);
      assertNotNull(method);
  ...
  @Test
  public void testCountAttachmentsMethodExists() {
    // Test that the countAttachments method exists with correct signature
    assertDoesNotThrow(() -> {
      Method method = SharePointAttachmentFunctions.class.getMethod(
          "countAttachments", DataContext.class, String.class, String.class);
      assertNotNull(method);
