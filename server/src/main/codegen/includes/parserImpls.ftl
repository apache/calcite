...
SqlLiteral privilegeObjects(SqlNodeList objects) :
{
    SqlNode e;
...
}
{
    (
        ...
        <ALL> <TABLES> <IN> <ROOT> <SCHEMA> {
            return SqlAuthCommand.ObjectType.ROOT_SCHEMA.symbol(getPos());
        }
    |
