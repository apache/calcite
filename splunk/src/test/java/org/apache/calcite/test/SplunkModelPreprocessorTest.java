...
public class SplunkModelPreprocessorTest {
  ...
  @Test void testFactoryInjectionForSplunkSchema() throws Exception {
  ...
  @Test void testTypeAndFactoryInjectionForMinimalSplunkSchema() throws Exception {
    String originalModel = "{\n"
        + "  \"version\": \"1.0\",\n"
        + "  \"schemas\": [\n"
        + "    {\n"
  ...
  @Test void testFactoryNotInjectedWhenAlreadyPresent() throws Exception {
    String originalModel = "{\n"
        + "  \"version\": \"1.0\",\n"
        + "  \"schemas\": [\n"
        + "    {\n"
  ...
  @Test void testFederationModelCreation() throws Exception {
    String model =
        SplunkModelHelper.createFederationModel("https://splunk.company.com:8089",
        "test_token",
        "Splunk_SA_CIM",
        "Splunk_TA_cisco-esa",
        "Splunk_TA_paloalto");
  ...
  @Test void testConnectionWithAutoInjectedFactories() throws Exception {
    String model =
        SplunkModelHelper.createFederationModel("mock",  // Use mock URL to avoid actual connection
        "test_token",
        "Splunk_SA_CIM");
  ...
  @Test void testHelperConnectMethod() throws Exception {
