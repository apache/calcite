...
public class SplunkJdbc43ReproducerTest extends SplunkTestBase {
  ...
  @Test public void testVarcharToIntConversionIssue() throws SQLException {
    assumeTrue(splunkAvailable, "Splunk not available");
  ...
  @Test public void testLongConversionIssue() throws SQLException {
    assumeTrue(splunkAvailable, "Splunk not available");
  ...
  @Test public void testDoubleConversionIssue() throws SQLException {
    assumeTrue(splunkAvailable, "Splunk not available");
  ...
  @Test public void testAlreadyNumericFieldWorks() throws SQLException {
    assumeTrue(splunkAvailable, "Splunk not available");
