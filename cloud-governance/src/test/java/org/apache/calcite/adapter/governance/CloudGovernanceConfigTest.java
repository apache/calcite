...
public class CloudGovernanceConfigTest {
  ...
  @Test public void testAzureConfig() {
    CloudGovernanceConfig.AzureConfig azureConfig =
        new CloudGovernanceConfig.AzureConfig("test-tenant-id", "test-client-id", "test-client-secret",
  ...
  @Test public void testGCPConfig() {
    CloudGovernanceConfig.GCPConfig gcpConfig =
        new CloudGovernanceConfig.GCPConfig(Arrays.asList("project-1", "project-2"), "/path/to/service-account.json");
  ...
  @Test public void testAWSConfig() {
    CloudGovernanceConfig.AWSConfig awsConfig =
        new CloudGovernanceConfig.AWSConfig(Arrays.asList("111111111111", "222222222222"), "us-west-2",
  ...
  @Test public void testFullCloudGovernanceConfig() {
    CloudGovernanceConfig.AzureConfig azure =
        new CloudGovernanceConfig.AzureConfig("azure-tenant", "azure-client", "azure-secret",
        Arrays.asList("azure-sub1", "azure-sub2"));

    CloudGovernanceConfig.GCPConfig gcp =
        new CloudGovernanceConfig.GCPConfig(Arrays.asList("gcp-project1", "gcp-project2"), "/gcp/credentials.json");

    CloudGovernanceConfig.AWSConfig aws =
        new CloudGovernanceConfig.AWSConfig(Arrays.asList("aws-account1", "aws-account2"), "us-east-1",
        "aws-key", "aws-secret", null);

    CloudGovernanceConfig config =
        new CloudGovernanceConfig(Arrays.asList("azure", "gcp", "aws"), azure, gcp, aws, true, 15);
  ...
  @Test public void testEmptySubscriptionLists() {
    CloudGovernanceConfig.AzureConfig azure =
        new CloudGovernanceConfig.AzureConfig("tenant", "client", "secret", Collections.emptyList());

    CloudGovernanceConfig.GCPConfig gcp =
        new CloudGovernanceConfig.GCPConfig(Collections.emptyList(), "/path/to/creds.json");

    CloudGovernanceConfig.AWSConfig aws =
        new CloudGovernanceConfig.AWSConfig(Collections.emptyList(), "us-east-1", "key", "secret", null);
  ...
  @Test public void testSingleSubscriptionLists() {
    CloudGovernanceConfig.AzureConfig azure =
        new CloudGovernanceConfig.AzureConfig("tenant", "client", "secret", Collections.singletonList("single-azure-sub"));

    CloudGovernanceConfig.GCPConfig gcp =
        new CloudGovernanceConfig.GCPConfig(Collections.singletonList("single-gcp-project"), "/path/to/creds.json");

    CloudGovernanceConfig.AWSConfig aws =
        new CloudGovernanceConfig.AWSConfig(Collections.singletonList("single-aws-account"), "us-east-1",
        "key", "secret", null);
  ...
  @Test public void testConfigDefaults() {
    CloudGovernanceConfig config =
        new CloudGovernanceConfig(null, null, null, null, null, null);
