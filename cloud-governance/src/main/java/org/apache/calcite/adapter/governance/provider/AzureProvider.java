...
public class AzureProvider implements CloudProvider {
  ...
  @Override
  public List<Map<String, Object>> queryStorageResources(List<String> subscriptionIds) {
    String kql = "Resources\n" +
        "| where type in (\n" +
  ...
  @Override
  public List<Map<String, Object>> queryComputeInstances(List<String> subscriptionIds) {
    String kql = "Resources\n" +
  ...
  @Override
  public List<Map<String, Object>> queryNetworkResources(List<String> subscriptionIds) {
    String kql = "Resources\n" +
        "| where type in (\n" +
  ...
  @Override
  public List<Map<String, Object>> queryIAMResources(List<String> subscriptionIds) {
    String kql = "Resources\n" +
        "| where type in (\n" +
  ...
  @Override
  public List<Map<String, Object>> queryDatabaseResources(List<String> subscriptionIds) {
    String kql = "Resources\n" +
        "| where type in (\n" +
  ...
  @Override
  public List<Map<String, Object>> queryContainerRegistries(List<String> subscriptionIds) {
    String kql = "Resources\n" +
