...
public class SparkAdapterTest {
  ...
  final String commonValuesExpr0 = "(values (1, 'a'), (2, 'b'))";

  final String commonValuesExpr1 = "(values (1, 'a'), (2, 'b')) as t(x, y)";

  final String commonValuesExpr2 =
      "(values (1, 'a'), (2, 'b'), (1, 'b'), (2, 'c'), (2, 'c')) as t(x, y)";

  final String commonValuesExpr3 = "(values (1, 'a'), (2, 'b')) as v(w, z)";

  final String commonValuesExpr4 =
  ...
  @Test public void testValues() throws SQLException {
    ...
    commonTester(sqlQuery, plan, expectedResult, false);
  }
  ...
  private void commonTester(final String sqlQuery,
      final String plan,
      final String expectedResult,
      final boolean orderedResult) throws SQLException {

    CalciteAssert.AssertQuery assertQuery =
        CalciteAssert.that()
            .with(CalciteAssert.Config.SPARK)
            .query(sqlQuery);

    assertQuery = orderedResult
        ? assertQuery.returns(expectedResult) : assertQuery.returnsUnordered(expectedResult);

    assertQuery.explainContains(plan);
  }
  ...
  @Test public void testGroupBy() throws SQLException {
    ...
    final String sqlQuery = "select sum(x) as SUM_X, min(y) as MIN_Y, max(y) as MAX_Y, "
  ...
  @Test public void testAggFuncNoGroupBy() throws SQLException {
  ...
  @Test public void testGroupByOrderByAsc() throws SQLException {
    final String sqlQuery = "select x, count(*) as CNT_Y\n"
        + "from " + commonValuesExpr2 + "\n"
        + "group by x\n"
        + "order by x asc";
    ...
    commonTester(sqlQuery, plan, expectedResult, true);
  }

  @Test public void testGroupByMinMaxCountCountDistinctOrderByAsc() throws SQLException {

    final String sqlQuery = "select x, min(y) as MIN_Y, max(y) as MAX_Y, count(*) as CNT_Y, "
  ...
  @Test public void testGroupByMinMaxCountCountDistinctOrderByDesc() throws SQLException {
  ...
  @Test public void testGroupByHaving() throws SQLException {

    final String sqlQuery = "select x\n"
        + "from " + commonValuesExpr2 + "\n"
        + "group by x\n"
        + "having count(*) > 2";
  ...
  @Test public void testUnionAll() throws SQLException {
    final String sqlQuery = "select *\n"
        + "from " + commonValuesExpr1 + "\n"
        + " union all\n"
        + "select *\n"
  ...
  @Test public void testUnion() throws SQLException {
    final String sqlQuery = "select *\n"
        + "from " + commonValuesExpr1 + "\n"
        + " union\n"
        + "select *\n"
  ...
  @Test public void testIntersect() throws SQLException {
    final String sqlQuery = "select *\n"
        + "from " + commonValuesExpr1 + "\n"
        + " intersect\n"
        + "select *\n"
  ...
  @Test public void testSortXAscProjectY() throws SQLException {

    final String sqlQuery = "select y\n"
        + "from " + commonValuesExpr2 + "\n"
        + "order by x asc";
  ...
  @Test public void testSortXDescYDescProjectY() throws SQLException {
  ...
  @Test public void testSortXDescYAscProjectY() throws SQLException {
  ...
  @Test public void testSortXAscYDescProjectY() throws SQLException {
  ...
  @Test public void testJoinProject() throws SQLException {

    final String sqlQuery = "select t.y, v.z\n"
        + "from " + commonValuesExpr2 + "\n"
  ...
  @Test public void testJoinProjectAliasProject() throws SQLException {

    final String sqlQuery = "select r.z\n"
        + "from (\n"
        + "  select *\n"
        + "  from " + commonValuesExpr2 + "\n"
  ...
  @Test public void testOrderByLimit() throws SQLException {
  ...
  @Test public void testOrderByOffset() throws SQLException {
  ...
  @Test public void testFilterBetween() throws SQLException {
  ...
  @Test public void testFilterIsIn() throws SQLException {
  ...
  @Test public void testFilterTrue() throws SQLException {
  ...
  @Test public void testFilterFalse() throws SQLException {
  ...
  @Test public void testFilterOr() throws SQLException {
  ...
  @Test public void testFilterIsNotNull() throws SQLException {
  ...
  @Test public void testFilterIsNull() throws SQLException {
  ...
  @Test public void testUnionWithFilters() throws SQLException {
  ...
  @Test public void testUnionWithFiltersProject() throws SQLException {
  ...
  @Test public void testArithmeticPlus() throws SQLException {
  ...
  @Test public void testArithmeticMinus() throws SQLException {
  ...
  @Test public void testArithmeticMul() throws SQLException {
  ...
  @Test public void testArithmeticDiv() throws SQLException {
  ...
  @Test public void testFilterExists() throws SQLException {
  ...
  @Ignore("[CALCITE-2184] java.lang.ClassCastException: RexSubQuery cannot be cast to RexLocalRef")
  @Test public void testFilterNotExists() throws SQLException {
  ...
  @Ignore("[CALCITE-2184] java.lang.ClassCastException: RexSubQuery cannot be cast to RexLocalRef")
  @Test public void testSubqueryAny() throws SQLException {
  ...
  @Ignore("[CALCITE-2184] java.lang.ClassCastException: RexSubQuery cannot be cast to RexLocalRef")
  @Test public void testSubqueryAll() throws SQLException {
