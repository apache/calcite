    ...
    checkQuery(17)
        ...
        .explainMatches("including all attributes ",
            CalciteAssert.checkMaskedResultContains(""
                ...
                + "            EnumerableHashJoin(condition=[AND(=($31, $79), =($30, $91))], joinType=[inner]): rowcount = 6.9978029381741304E16, cumulative cost = {7.0048033021638352E16 rows, 3.097652327744654E12 cpu, 0.0 io}\n"
                + "              EnumerableSort(sort0=[$31], sort1=[$30], sort2=[$37], dir0=[ASC], dir1=[ASC], dir2=[ASC]): rowcount = 7.87597881975E8, cumulative cost = {1.5760413031966867E9 rows, 3.097646138009654E12 cpu, 0.0 io}\n"
