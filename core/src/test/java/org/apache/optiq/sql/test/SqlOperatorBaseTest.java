 ...
 * {@link SqlTester#setFor(org.apache.optiq.sql.SqlOperator, org.apache.optiq.sql.test.SqlTester.VmName...)}
...
public abstract class SqlOperatorBaseTest {
  ...
  /**
   * Creates a {@link org.apache.optiq.sql.test.SqlTester} based on a JDBC
   * connection.
   */
  ...
  /**
   * Implementation of {@link org.apache.optiq.sql.test.SqlTester} based on a
   * JDBC connection.
   */
