...
import static org.apache.optiq.test.OptiqAssert.that;
...
public class JdbcFrontJdbcBackLinqMiddleTest {
  ...
  @Test public void testPlan() {
    that()
        ...
        .planContains(
            ...
            + "                if (v != null && org.apache.optiq.runtime.SqlFunctions.eq(v, \"USA\")) {\n"
            + "                  return true;\n"
            + "                }\n"
            + "              }\n"
            + "              return false;\n"
  ...
  @Test public void testPlan2() {
    that()
        ...
        .planContains(
            ...
            + "              if (org.apache.optiq.runtime.SqlFunctions.eq((String) current12[12], \"USA\") && (v1 != null && org.apache.optiq.runtime.SqlFunctions.eq(org.apache.optiq.runtime.SqlFunctions.upper(v1), org.apache.optiq.runtime.SqlFunctions.trim(org.apache.optiq.runtime.SqlFunctions.upper(\"CA\"))))) {\n"
            + "                return true;\n"
            + "              }\n"
            + "            }\n"
            + "            return false;\n"
  ...
  @Test public void testPlan3() {
    ...
    that()
        ...
        .planContains(
            "  final org.apache.linq4j.Enumerable _inputEnumerable1 = left.join(right, new org.apache.linq4j.function.Function1() {\n");
  }
}
