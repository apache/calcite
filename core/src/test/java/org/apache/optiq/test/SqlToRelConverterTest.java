...
/**
 * Unit test for {@link org.apache.optiq.sql2rel.SqlToRelConverter}.
 */
public class SqlToRelConverterTest extends SqlToRelTestBase {
   ...
   * the operator (in this case, {@link org.apache.optiq.sql.fun.SqlCaseOperator}).
   */
   ...
   * org.apache.optiq.sql.fun.SqlStdOperatorTable#CHARACTER_LENGTH}).
   */
