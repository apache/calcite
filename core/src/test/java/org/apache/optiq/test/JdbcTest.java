...
import org.apache.optiq.tools.SqlRun;
...
import org.apache.optiq.sql.advise.SqlAdvisorGetHintsFunction;
import org.apache.optiq.sql.parser.SqlParserUtil;
import org.apache.optiq.sql.type.SqlTypeName;
import org.apache.optiq.util.Bug;
...
public class JdbcTest {
    ...
    try {
      ...
      assertThat(e.getMessage(),
          containsString(
              ...
              + "org.apache.optiq.QueryableTable org"
              + ".apache.optiq.test.JdbcTest"
  ...
  /**
   * Tests {@link org.apache.optiq.sql.advise.SqlAdvisorGetHintsFunction}.
   */
   ...
   * {@link org.apache.optiq.TranslatableTable}.
   */
   ...
   * {@link org.apache.optiq.test.JdbcTest.IntString} values. */
  ...
  /** Tests {@link org.apache.avatica.Handler#onConnectionClose}
   * and  {@link org.apache.avatica.Handler#onStatementClose}. */
  ...
  @Test public void testVersion() throws ClassNotFoundException, SQLException {
    ...
    // stored in org-apache-optiq-jdbc.properties, but derived from
  ...
  /** Unit test for
   * {@link org.apache.optiq.jdbc.MetaImpl#likeToRegex(org.apache.avatica.Meta.Pat)}. */
...
//      if (query.i != FOODMART_QUERIES.size() - 1) continue;
   ...
   * {@link org.apache.optiq.rel.rules.SwapJoinRule} does not manifest as an
   * {@link org.apache.optiq.impl.enumerable.JavaRules.EnumerableCalcRel} in the
   * plan.
   *
   ...
   * {@link org.apache.optiq.rel.rules.PushJoinThroughJoinRule} makes this
   * possible. */
  @Ignore
  ...
  @Test public void testReuseExpressionWhenNullChecking() {
    OptiqAssert.that()
        ...
        .planContains(
            "static final String $L4J$C$org_apache_optiq_runtime_SqlFunctions_upper_y_ = "
            + "org.apache.optiq.runtime.SqlFunctions.upper(\"y\");")
        .planContains(
            "return current.empid <= current.deptno * 10 "
            + "? (String) null "
            + ": $L4J$C$org_apache_optiq_runtime_SqlFunctions_upper_y_;")
        .returns(
            "T=null\n"
            + "T=null\n"
            + "T=Y\n"
  ...
  @Test public void testReuseExpressionWhenNullChecking2() {
    OptiqAssert.that()
        ...
        .planContains(
            ...
            + "|| inp2_ == null "
            + "? (String) null "
            + ": org.apache.optiq.runtime.SqlFunctions.upper(inp2_);")
        .returns(
            "T=null\n"
            + "T=null\n"
            + "T=SEBASTIAN\n"
  ...
  @Test public void testReuseExpressionWhenNullChecking3() {
    OptiqAssert.that()
        ...
        .planContains(
            "final String inp2_ = current.name;")
        .planContains(
            "static final boolean $L4J$C$org_apache_optiq_runtime_SqlFunctions_ne_sa_sa_ = "
            + "org.apache.optiq.runtime.SqlFunctions.ne(\"sa\", \"sa\");")
        .planContains(
            "static final boolean $L4J$C$_org_apache_optiq_runtime_SqlFunctions_ne_sa_sa_ = "
            + "!$L4J$C$org_apache_optiq_runtime_SqlFunctions_ne_sa_sa_;")
        .planContains(
            "return inp2_ == null || $L4J$C$_org_apache_optiq_runtime_SqlFunctions_ne_sa_sa_ ? (String) null"
            + " : org.apache.optiq.runtime.SqlFunctions.substring(inp2_, "
            + "current.deptno + 1);");
  }
  ...
  @Test public void testReuseExpressionWhenNullChecking4() {
    OptiqAssert.that()
        ...
        .planContains(
            "static final boolean $L4J$C$org_apache_optiq_runtime_SqlFunctions_eq_sa_sa_ = "
            + "org.apache.optiq.runtime.SqlFunctions.eq(\"sa\", \"sa\");")
        .planContains(
            "static final boolean $L4J$C$_org_apache_optiq_runtime_SqlFunctions_eq_sa_sa_ = "
            + "!$L4J$C$org_apache_optiq_runtime_SqlFunctions_eq_sa_sa_;")
        .planContains(
            "return inp2_ == null "
            + "|| $L4J$C$_org_apache_optiq_runtime_SqlFunctions_eq_sa_sa_ "
            + "|| !v5 && inp1_ * 8 <= 8 "
            + "? (String) null "
            + ": org.apache.optiq.runtime.SqlFunctions.substring("
            + "org.apache.optiq.runtime.SqlFunctions.trim(true, true, \" \", "
            + "org.apache.optiq.runtime.SqlFunctions.substring(inp2_, "
            + "inp1_ * 0 + 1)), (v5 ? 4 : 5) - 2);")
        .returns(
            "T=ill\n"
   ...
   *
   * @see org.apache.avatica.AvaticaDatabaseMetaData#nullsAreSortedAtEnd()
   */
  ...
  @Test public void testLimitZero() {
    OptiqAssert.that()
        ...
        .returns("")
        .planContains(
            "return org.apache.linq4j.Linq4j.asEnumerable(new Object[] {})");
  }
  ...
  @Test public void testWinAgg() {
    OptiqAssert.that()
        ...
        .planContains(
            ...
            + "                  org.apache.optiq.runtime.SqlFunctions.toLong(current[4]) > 0L ? Float.valueOf(org.apache.optiq.runtime.SqlFunctions.toFloat(current[5])) : (Float) null,\n"
            + "                  5,\n"
            + "                  current[6],\n"
            + "                  current[7]};\n");
  }
   ...
   * {@link org.apache.optiq.impl.enumerable.JavaRowFormat#SCALAR} inputs.
  ...
  @Test public void testWinAggScalarNonNullPhysType() {
    String planLine =
        "a0s0w0 = org.apache.optiq.runtime.SqlFunctions.lesser(a0s0w0, org.apache.optiq.runtime.SqlFunctions.toFloat(_rows[j]));";
  ...
  /**
   * Tests that {@link org.apache.optiq.rel.CalcRel} is implemented properly
   * when input is {@link org.apache.optiq.rel.WindowRel} and literal.
   */
   ...
   * {@link org.apache.avatica.Handler.ResultSink}. */
  ...
  /** Test for
   * {@link org.apache.optiq.resource.EigenbaseNewResource#requireDefaultConstructor(String)}. */
  @Test public void testUserDefinedFunction2() throws Exception {
    withBadUdf(AwkwardFunction.class)
        .connectThrows(
            "Declaring class 'org.apache.optiq.test.JdbcTest$AwkwardFunction' of non-static user-defined function must have a public constructor with zero parameters");
  }
  ...
  /** Test for
   * {@link org.apache.optiq.resource.EigenbaseNewResource#firstParameterOfAdd(String)}. */
  @Test public void testUserDefinedAggregateFunction3() throws Exception {
    withBadUdf(SumFunctionBadIAdd.class).connectThrows(
        "Caused by: java.lang.RuntimeException: In user-defined aggregate class 'org.apache.optiq.test.JdbcTest$SumFunctionBadIAdd', first parameter to 'add' method must be the accumulator (the return type of the 'init' method)");
  }
  ...
  public static class AutoTempDriver
      extends org.apache.optiq.jdbc.Driver {
  ...
  public static class HandlerDriver extends org.apache.optiq.jdbc.Driver {
