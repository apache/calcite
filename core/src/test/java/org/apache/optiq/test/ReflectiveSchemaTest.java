...
import static org.apache.optiq.test.JdbcTest.Employee;
...
public class ReflectiveSchemaTest {
  ...
  /**
   * Test that uses a JDBC connection as a linq4j {@link org.apache.linq4j.QueryProvider}.
   *
  ...
  @Test public void testQueryProvider() throws Exception {
    ...
    List<Object[]> list =
        queryProvider.createQuery(
            Expressions.call(
                Expressions.call(
                    org.apache.linq4j.expressions.Types.of(
                        Enumerable.class,
                        Employee.class),
                    null,
   ...
   * The function returns a {@link org.apache.linq4j.Queryable}.
   */
  @Ignore
  ...
  @Test public void testDivideWraperWrapper() throws Exception {
    ...
    with.query(
        ...
        + " from \"s\".\"everyTypes\" where \"primitiveLong\" <> 0")
        .planContains(
            "final Long inp13_ = ((org.apache.optiq.test.ReflectiveSchemaTest.EveryType) inputEnumerator.current()).wrapperLong;")
        .planContains(
