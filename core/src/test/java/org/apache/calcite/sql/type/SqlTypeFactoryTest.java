...
public class SqlTypeFactoryTest {
  ...
  @Test public void checkArrayPrecendenceList() {
    Fixture f = new Fixture();
    assertThat(checkPrecendenceList(f.arrayBigInt, f.arrayBigInt, f.arrayFloat), is(3));
    assertThat(
        checkPrecendenceList(f.arrayOfArrayBigInt, f.arrayOfArrayBigInt, f.arrayOfArrayFloat),
        is(3));
    ...
    try {
      checkPrecendenceList(f.arrayBigInt, f.sqlBigInt, f.sqlInt);
