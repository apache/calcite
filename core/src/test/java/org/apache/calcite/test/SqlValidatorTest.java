...
*/
  ...
  @Test public void testArrayOfRecordType() {
    ...
    sql("SELECT dept_nested.employees[1].detail.skills[1].desc as DESCRIPTION from dept_nested")
        .type("RecordType(VARCHAR(20) DESCRIPTION) NOT NULL");
    sql("SELECT dept_nested.employees[1].detail.skills[1].others.a as oa from dept_nested")
