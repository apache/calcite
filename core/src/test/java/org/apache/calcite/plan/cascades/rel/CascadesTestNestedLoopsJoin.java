 ...
 *
 */
public class CascadesTestNestedLoopsJoin extends Join implements PhysicalNode {

  protected CascadesTestNestedLoopsJoin(RelOptCluster cluster, RelTraitSet traitSet,
  ...
  @Override public CascadesTestNestedLoopsJoin copy(RelTraitSet traitSet, RexNode conditionExpr,
      RelNode left, RelNode right,
      JoinRelType joinType, boolean semiJoinDone) {
    return new CascadesTestNestedLoopsJoin(getCluster(), traitSet, ImmutableList.of(), left, right,
