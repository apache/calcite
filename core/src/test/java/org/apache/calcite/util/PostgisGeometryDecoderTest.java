...
/**
 * Tests for the {@link PostgisGeometryDecoder} class.
 *
 *
 * <p>These tests are based on the values retrieved from PostGIS using the JDBC driver for PostgreSQL.
 */
class PostgisGeometryDecoderTest {
  ...
  private static final String POLYGON =
      "";

  private static final String MULTIPOINT =
      "0104000020E6100000020000000101000000000000000000000000000000000000000101000000000000000000F03F000000000000F03F";

  private static final String MULTILINESTRING =
      "0105000020E61000000200000001020000000200000000000000000000000000000000000000000000000000F03F000000000000F03F0102000000020000000000000000000040000000000000004000000000000008400000000000000840";

  private static final String MULTIPOLYGON =
      "";
  ...
  @Test void decodePolygon() {
    ...
    assertEquals("POLYGON ((0 0, 1 0, 1 1, 0 1, 0 0), (0.5 0.5, 0.5 0.6, 0.6 0.6, 0.6 0.5, 0.5 0.5))", new WKTWriter().write(geometry));
  }
  ...
  @Test void decodeMultiPoint() {
    ...
    assertEquals("MULTIPOINT ((0 0), (1 1))", new WKTWriter().write(geometry));
  }
  ...
  @Test void decodeMultiLineString() {
    ...
    assertEquals("MULTILINESTRING ((0 0, 1 1), (2 2, 3 3))", new WKTWriter().write(geometry));
  }
  ...
  @Test void decodeMultiPolygon() {
    ...
    assertEquals("MULTIPOLYGON (((0 0, 1 0, 1 1, 0 1, 0 0)), ((2 2, 3 2, 3 3, 2 3, 2 2)))", new WKTWriter().write(geometry));
  }
  ...
  @Test void decodeGeometryCollection() {
    ...
    assertEquals("GEOMETRYCOLLECTION (POINT (0 0), LINESTRING (1 1, 2 2))", new WKTWriter().write(geometry));
  }
}
