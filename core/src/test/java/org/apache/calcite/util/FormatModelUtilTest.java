...
public class FormatModelUtilTest {
  ...
  private final static ImmutableMap testMap = FormatModel.BIG_QUERY_FORMAT_ELEMENT_PARSE_MAP;

  private void assertFormatElementParse(String fmtStr, List<String> expected) {
    StringBuilder buf = new StringBuilder();
    ArrayList<String> collector = new ArrayList<>();
    List<FormatModelElement> result = FormatModelUtil.parse(fmtStr, testMap);
