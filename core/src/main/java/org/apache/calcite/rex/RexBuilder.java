...
public class RexBuilder {
  ...
  public RexNode makeCast(
      ...
      RelDataType type,
      RexNode exp) {
    return makeCast(pos, type, exp, false, false);
  }
  ...
  public RexNode makeCast(
      ...
      boolean matchNullability,
      boolean safe) {
    return makeCast(SqlParserPos.ZERO, type, exp, matchNullability, safe);
  }
  ...
  public RexNode makeCast(
    ...
    if (exp instanceof RexLiteral) {
      ...
      if (canRemoveCastFromLiteral(type, value, typeName)) {
        ...
        if (type.isNullable()
            ...
            && matchNullability) {
          return makeAbstractCast(pos, type, literal2, safe);
        }
        return literal2;
      }
    ...
    return makeAbstractCast(pos, type, exp, safe);
  }
