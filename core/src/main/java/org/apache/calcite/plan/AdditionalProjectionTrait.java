...
public class AdditionalProjectionTrait implements RelTrait {
  ...
  @Override public boolean satisfies(RelTrait trait) {
    throw new UnsupportedOperationException("Method not implemented for AdditionalProjectionTrait");
  }

  @Override public void register(RelOptPlanner planner) {
    throw new UnsupportedOperationException("Registration not supported for AdditionalProjectionTrait");
  }
}
