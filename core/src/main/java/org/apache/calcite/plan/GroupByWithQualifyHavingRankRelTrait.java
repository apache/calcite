...
public class GroupByWithQualifyHavingRankRelTrait implements RelTrait {
  ...
  public boolean satisfies(RelTrait trait) {
    throw new UnsupportedOperationException("Method not implemented for GroupWithQualifyHavingRankRelTrait");
  }

  public void register(RelOptPlanner planner) {
    throw new UnsupportedOperationException("Registration not supported for GroupWithQualifyHavingRankRelTrait");
  }
}
