...
public class SqlFloorFunction extends SqlMonotonicUnaryFunction {
  ...
  @Override public void unparse(SqlWriter writer, SqlCall call, int leftPrec,
    ...
    if (call.operandCount() == 2) {
      ...
      unparseNumeric(writer, call, leftPrec, rightPrec);
    }
  }

  private void unparseNumeric(SqlWriter writer, SqlCall call, int leftPrec,
      int rightPrec) {
  ...
  private void unparseDatetime(SqlWriter writer, SqlCall call, int leftPrec,
      int rightPrec) {
  ...
  private String convertToHsqlDb(TimeUnitRange unit) {
    switch (unit) {
    case YEAR:
      return "YYYY";
    case MONTH:
