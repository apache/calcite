...
public class SqlDataTypeSpec extends SqlNode {
  ...
  public SqlDataTypeSpec(
      ...
      Boolean nullable,
      SqlParserPos pos) {
    this(collectionsTypeName, typeName, typeName, precision, scale, charSetName, timeZone,
        nullable, pos);
  }
  ...
  public RelDataType deriveType(SqlValidator validator) {
    ...
    if (typeName.isSimple()) {
      ...
      relDataType = deriveType(typeFactory);
    }
    if (relDataType == null) {
      relDataType = validator.getValidatedNodeType(typeName);
    }
    return relDataType;
  }
