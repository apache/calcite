...
/**
 * The <code>JSON_UNQUOTE</code> function.
 */
public class SqlJsonUnQuoteFunction extends SqlFunction {
  public SqlJsonUnQuoteFunction() {
    super("JSON_UNQUOTE",
...
// End SqlJsonUnQuoteFunction.java
