...
public class SqlValidatorImpl implements SqlValidatorWithHints {
  ...
  private boolean expandSelectItem(
    ...
    final String alias = deriveAliasNonNull(
        selectItem,
        aliases.size());
    ...
    if (expanded != selectItem) {
      String newAlias = deriveAliasNonNull(
          expanded,
          aliases.size());
      ...
      if (identifier.getSimple().equals(name)) {
        ...
        for (ScopeChild child : requireNonNull(scope, "scope").children) {
          if (child.namespace.getRowType()
            ...
            final SqlIdentifier exp = new SqlIdentifier(
        ...
        final SqlNode finalNode = SqlStdOperatorTable.AS.createCall(SqlParserPos.ZERO,
  ...
  private static void findAllValidFunctionNames(
    ...
    for (SqlOperator op : validator.getOperatorTable().getOperatorList()) {
      SqlIdentifier curOpId = new SqlIdentifier(
          op.getName(),
          pos);
  ...
  @Override
  public void validateQuery(SqlNode node, @Nullable SqlValidatorScope scope,
  ...
  protected @PolyNull SqlNode performUnconditionalRewrites(
    ...
    switch (kind) {
      ...
      case ORDER_BY: {
        ...
        return new SqlSelect(SqlParserPos.ZERO, null, null, selectList, orderBy.query,
  ...
  private static void rewriteMerge(SqlMerge call) {
    ...
    SqlNode outerJoin = new SqlJoin(SqlParserPos.ZERO,
        leftJoinTerm,
        ...
        call.getCondition());
    SqlSelect select = new SqlSelect(SqlParserPos.ZERO, null, selectList, outerJoin, null, null,
    ...
    if (insertCall != null) {
      ...
      select = new SqlSelect(SqlParserPos.ZERO, null, selectList, insertSource, null, null,
          null, null, null, null, null, null, null, null);
  ...
  private SqlNode rewriteUpdateToMerge(
    ...
    SqlNode selfJoinCond = SqlStdOperatorTable.EQUALS.createCall(
        SqlParserPos.ZERO,
        selfJoinSrcExpr,
        selfJoinTgtExpr);
    if (condition == null) {
      ...
      condition = SqlStdOperatorTable.AND.createCall(
          SqlParserPos.ZERO,
          selfJoinCond,
          condition);
    }
    ...
    IdentifierNamespace ns = new IdentifierNamespace(this, target, null,
        castNonNull(null));
    RelDataType rowType = ns.getRowType();
    ...
    source = new SqlSelect(SqlParserPos.ZERO, null, selectList, source, null, null, null,
        null, null, null, null, null, null, null);
    source = SqlValidatorUtil.addAlias(source, UPDATE_SRC_ALIAS);
    SqlMerge mergeCall = new SqlMerge(updateCall.getParserPosition(), target, condition, source,
  ...
  protected SqlSelect createSourceSelectForUpdate(SqlUpdate call) {
    ...
    return new SqlSelect(SqlParserPos.ZERO, null, selectList, sourceTable,
        null, call.getCondition(), null, null, null, null, null, null, null, null);
  }
  ...
  public RelDataType deriveConstructorType(
    ...
    if (resolvedConstructor == null) {
      ...
      SqlCall testCall = resolvedConstructor.createCall(
          ...
          call.getOperandList());
      RelDataType returnType = resolvedConstructor.validateOperands(
          this,
          scope,
          testCall);
  ...
  public CalciteException handleUnresolvedFunction(SqlCall call,
    ...
    if (unresolvedFunction instanceof SqlFunction) {
      ...
      signature = typeChecking.getAllowedSignatures(unresolvedFunction,
  ...
  protected void addToSelectList(
    ...
    String uniqueAlias = SqlValidatorUtil.uniquify(
  ...
  @Override
  public @Nullable String deriveAlias(
      SqlNode node,
      int ordinal) {
  ...
  private SqlNode registerFrom(
    ...
    switch (kind) {
      case AS:
        ...
        final boolean needAlias = call.operandCount() > 2
            ...
            || expr.getKind() == SqlKind.UNNEST
                && (((SqlCall) expr).operand(0).getKind() == SqlKind.ARRAY_VALUE_CONSTRUCTOR
                    || ((SqlCall) expr).operand(0).getKind() == SqlKind.MULTISET_VALUE_CONSTRUCTOR);
      ...
      case JOIN:
        ...
        final SqlNode newLeft = registerFrom(
            parentScope,
            joinScope,
            true,
            left,
        ...
        final SqlNode newRight = registerFrom(
            parentScope,
            joinScope,
            true,
            right,
  ...
  private void registerQuery(
    ...
    switch (node.getKind()) {
      ...
      case VALUES:
        ...
        final TableConstructorNamespace tableConstructorNamespace = new TableConstructorNamespace(
            this,
            call,
            parentScope,
            enclosingNode);
      ...
      case INSERT:
        ...
        InsertNamespace insertNs = new InsertNamespace(
            this,
            insertCall,
            enclosingNode,
            parentScope);
      ...
      case DELETE:
        ...
        DeleteNamespace deleteNs = new DeleteNamespace(
            this,
            deleteCall,
            enclosingNode,
            parentScope);
      ...
      case UPDATE:
        ...
        UpdateNamespace updateNs = new UpdateNamespace(
            this,
            updateCall,
            enclosingNode,
            parentScope);
      ...
      case MERGE:
        ...
        MergeNamespace mergeNs = new MergeNamespace(
            this,
            mergeCall,
            enclosingNode,
            parentScope);
      ...
      case OTHER_FUNCTION:
        call = (SqlCall) node;
        ProcedureNamespace procNs = new ProcedureNamespace(
            this,
            parentScope,
            call,
            enclosingNode);
  ...
  protected void validateJoin(SqlJoin join, SqlValidatorScope scope) {
    ...
    if (natural) {
      ...
      final SqlNameMatcher nameMatcher = catalogReader.nameMatcher();
      List<String> naturalColumnNames = SqlValidatorUtil.deriveNaturalJoinColumnList(nameMatcher,
  ...
  private void checkRollUp(@Nullable SqlNode grandParent, @Nullable SqlNode parent,
    ...
    if (current instanceof SqlCall && !(current instanceof SqlSelect)) {
      ...
      List<? extends @Nullable SqlNode> children = ((SqlCall) stripAs(stripDot)).getOperandList();
  ...
  protected RelDataType validateSelectList(
    ...
    for (SqlNode selectItem : selectItems) {
      if (selectItem instanceof SqlSelect) {
        ...
        final RelDataType fieldType = targetRowType.isStruct()
    ...
    SqlNodeList newSelectList = new SqlNodeList(
        expandedSelectItems,
  ...
  protected RelDataType createTargetRowType(
    ...
    for (SqlNode node : targetColumnList) {
      SqlIdentifier id = (SqlIdentifier) node;
      RelDataTypeField targetField = SqlValidatorUtil.getTargetField(
  ...
  public void validateInsert(SqlInsert insert) {
    ...
    final RelDataType targetRowType = createTargetRowType(
        table,
    ...
    final List<ColumnStrategy> strategies = table.unwrapOrThrow(RelOptTable.class).getColumnStrategies();
    ...
    final RelDataType targetRowTypeToValidate = logicalSourceRowType.getFieldCount() == logicalTargetRowType
        .getFieldCount()
  ...
  private void checkConstraint(
    ...
    if (modifiableViewTable != null && source instanceof SqlCall) {
      ...
      final Map<Integer, RelDataTypeField> tableIndexToTargetField = SqlValidatorUtil.getIndexToFieldMap(tableFields,
          targetRowType);
      ...
      final ImmutableBitSet targetColumns = ImmutableBitSet.of((Iterable<Integer>) tableIndexToTargetField.keySet());
      @SuppressWarnings("RedundantCast")
      final ImmutableBitSet constrainedColumns = ImmutableBitSet.of((Iterable<Integer>) projectMap.keySet());
      @SuppressWarnings("assignment.type.incompatible")
      List<@KeyFor({ "tableIndexToTargetField", "projectMap" }) Integer> constrainedTargetColumns = targetColumns
          .intersect(constrainedColumns).asList();
  ...
  private void checkConstraint(
    ...
    if (modifiableViewTable != null) {
      ...
      final List<String> targetNames = SqlIdentifier.simpleNames(update.getTargetColumnList());
      ...
      Pair.forEach(targetNames, sources, (columnName, expr) -> {
        ...
        if (projectMap.containsKey(columnIndex)) {
          ...
          final ValidationError validationError = new ValidationError(expr,
   ...
   * @param targetRowTypeToValidate row type to validate mainly for column
   *                                strategies
   * @param realTargetRowType       target table row type exclusive virtual
   *                                columns
   * @param source                  source node
   * @param logicalSourceRowType    source node row type
   * @param logicalTargetRowType    logical target row type, contains only target
   *                                columns if
   *                                they are specified or if the sql dialect
   *                                allows subset insert,
   *                                make a subset of fields(start from the left
   *                                first field) whose
   ...
   * @param targetRowType Target row type, it should either contain all the
   *                      virtual columns
  ...
  public void validateMerge(SqlMerge call) {
    ...
    IdentifierNamespace targetNamespace = (IdentifierNamespace) getNamespaceOrThrow(call.getTargetTable());
    validateNamespace(targetNamespace, unknownType);
  ...
  public void validatePivot(SqlPivot pivot) {
    ...
    pivot.forEachNameValues((alias, nodeList) -> {
      ...
      Pair.forEach(aggNames, (aggAlias, aggType) -> typeBuilder.add(aggAlias == null ? alias : alias + "_" + aggAlias,
          aggType));
    });
  ...
  public void validateUnpivot(SqlUnpivot unpivot) {
    final UnpivotScope scope = (UnpivotScope) requireNonNull(getJoinScope(unpivot), () -> "scope for " + unpivot);
    ...
    Ord.forEach(unpivot.measureList, (measure, i) -> {
      ...
      final RelDataType type = typeFactory.createTypeWithNullability(type0,
    ...
    Ord.forEach(unpivot.axisList, (axis, i) -> {
      ...
      final List<RelDataType> types = new ArrayList<>();
      unpivot.forEachNameValues((aliasList, valueList) -> types.add(
          valueList == null
  ...
  private static class PatternVarVisitor implements SqlVisitor<Void> {
    ...
    @Override
    public Void visit(SqlJsonFieldReference literal) {
      return null;
    }
  ...
  private class DeriveTypeVisitor implements SqlVisitor<RelDataType> {
    ...
    @Override
    public RelDataType visit(SqlJsonFieldReference literal) {
      return null;
    }
  ...
  class OrderExpressionExpander extends SqlScopedShuttle {
    ...
    private SqlNode nthSelectItem(int ordinal, final SqlParserPos pos) {
      ...
      SqlNodeList expandedSelectList = expandStar(
  ...
  /**
   * Shuttle which walks over an expression in the GROUP BY/HAVING clause,
   * replacing
        ...
        case JOIN:
          ...
          if (names != null) {
            for (String name : names) {
              ...
              final boolean nullable = (f.getType().isNullable()
    ...
    public void permute(List<SqlNode> selectItems,
      ...
      for (ImmutableIntList source : sources) {
        ...
        for (int p1 : Util.skip(source)) {
          ...
          selectItem = SqlStdOperatorTable.AS.createCall(SqlParserPos.ZERO,
              SqlStdOperatorTable.COALESCE.createCall(SqlParserPos.ZERO,
