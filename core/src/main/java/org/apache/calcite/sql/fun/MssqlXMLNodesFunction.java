...
/**
 * MSSQL XML NODES function.
 */
public class MssqlXMLNodesFunction extends SqlFunction implements SqlTableFunction {

  private final Map<String, RelDataType> columnDefinitions;

  public MssqlXMLNodesFunction(Map<String, RelDataType> columnDefinitions) {
    super("NODES",
        SqlKind.OTHER_FUNCTION,
        ReturnTypes.XML,
        null,
        OperandTypes.and(OperandTypes.family(SqlTypeFamily.VARIANT),
