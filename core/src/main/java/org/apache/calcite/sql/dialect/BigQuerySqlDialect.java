...
import static org.apache.calcite.sql.SqlDateTimeFormat.MILISECOND;
...
import static org.apache.calcite.sql.SqlDateTimeFormat.YYYYMMDD_HH24_MI_SS_MS;
...
public class BigQuerySqlDialect extends SqlDialect {
  ...
  private static final Map<SqlDateTimeFormat, String> DATE_TIME_FORMAT_MAP =
      new HashMap<SqlDateTimeFormat, String>() {{
        ...
        put(YYMMDD, "%y%m%d");
        put(DAYOFWEEK, "%A");
        put(YYYYMMDD_HH24_MI_SS_MS, "%Y%m%d %H:%M:%E*S");
        put(MILISECOND, "*S");
