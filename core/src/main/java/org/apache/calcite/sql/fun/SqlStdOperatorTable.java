...
public class SqlStdOperatorTable extends ReflectiveSqlOperatorTable {
        ...
        public static final SqlSetOperator INTERSECT_ALL = new SqlSetOperator("INTERSECT ALL", SqlKind.INTERSECT, 14,
                        true);

        /**
         * The {@code MULTISET UNION DISTINCT} operator.
         */
        public static final SqlMultisetSetOperator MULTISET_UNION_DISTINCT = new SqlMultisetSetOperator(
                        "MULTISET UNION DISTINCT", 12, false);

        /**
         * The {@code MULTISET UNION [ALL]} operator.
         */
        public static final SqlMultisetSetOperator MULTISET_UNION = new SqlMultisetSetOperator("MULTISET UNION ALL", 12,
                        true);

        /**
         * The {@code MULTISET EXCEPT DISTINCT} operator.
         */
        public static final SqlMultisetSetOperator MULTISET_EXCEPT_DISTINCT = new SqlMultisetSetOperator(
                        "MULTISET EXCEPT DISTINCT", 12, false);

        /**
         * The {@code MULTISET EXCEPT [ALL]} operator.
         */
        public static final SqlMultisetSetOperator MULTISET_EXCEPT = new SqlMultisetSetOperator("MULTISET EXCEPT ALL",
                        12,
                        true);
         ...
         */
        public static final SqlMultisetSetOperator MULTISET_INTERSECT_DISTINCT = new SqlMultisetSetOperator(
                        "MULTISET INTERSECT DISTINCT", 14, false);

        /**
         * The {@code MULTISET INTERSECT [ALL]} operator.
         */
        public static final SqlMultisetSetOperator MULTISET_INTERSECT = new SqlMultisetSetOperator(
         ...
         *
         * <p>
         * Some history. The {@code GROUPING} function is in the SQL standard,
         ...
         *
         * <p>
         * The SQL standard has changed to allow {@code GROUPING} to have multiple
         ...
         */
        public static final SqlBinaryOperator PERCENT_REMAINDER = new SqlBinaryOperator(
                        "%",
                        SqlKind.MOD,
                        60,
                        true,
         ...
         */
        public static final SqlBinaryOperator DIVIDE_INTEGER = new SqlBinaryOperator(
                        "/INT",
                        SqlKind.DIVIDE,
                        60,
                        true,
         ...
         */
        public static final SqlBinaryOperator IS_DISTINCT_FROM = new SqlBinaryOperator(
                        "IS DISTINCT FROM",
         ...
         */
        public static final SqlBinaryOperator IS_NOT_DISTINCT_FROM = new SqlBinaryOperator(
         ...
         * significant.
         */
        public static final SqlBinaryOperator IS_DIFFERENT_FROM = new SqlBinaryOperator(
                        "$IS_DIFFERENT_FROM",
                        SqlKind.OTHER,
                        30,
                        true,
        ...
        public static final SqlQuantifyOperator SOME_LE = new SqlQuantifyOperator(SqlKind.SOME,
        ...
        public static final SqlQuantifyOperator ALL_LE = new SqlQuantifyOperator(SqlKind.ALL,
                        SqlKind.LESS_THAN_OR_EQUAL);
         ...
         */
        public static final SqlBinaryOperator MINUS = new SqlMonotonicBinaryOperator(
                        "-",
                        SqlKind.MINUS,
                        40,
                        true,
         ...
         */
        public static final SqlBinaryOperator MULTIPLY = new SqlMonotonicBinaryOperator(
                        "*",
                        SqlKind.TIMES,
                        60,
                        true,
         ...
         */
        public static final SqlBinaryOperator PLUS = new SqlMonotonicBinaryOperator(
                        "+",
                        SqlKind.PLUS,
                        40,
                        true,
         ...
         *
         * <p>
         * The following returns <code>true</code>, in part because multisets are
         * order-independent:
         *
         * <blockquote>
        ...
        // POSTFIX OPERATORS
        // -------------------------------------------------------------
        public static final SqlPostfixOperator DESC = new SqlPostfixOperator(
                        "DESC",
                        SqlKind.DESCENDING,
                        20,
                        ReturnTypes.ARG0,
        ...
        public static final SqlPostfixOperator NULLS_FIRST = new SqlPostfixOperator(
                        "NULLS FIRST",
                        SqlKind.NULLS_FIRST,
                        18,
                        ReturnTypes.ARG0,
        ...
        public static final SqlPostfixOperator NULLS_LAST = new SqlPostfixOperator(
                        "NULLS LAST",
                        SqlKind.NULLS_LAST,
                        18,
                        ReturnTypes.ARG0,
        ...
        public static final SqlPostfixOperator IS_NOT_UNKNOWN = new SqlPostfixOperator(
                        "IS NOT UNKNOWN",
                        SqlKind.IS_NOT_NULL,
                        28,
                        ReturnTypes.BOOLEAN_NOT_NULL,
        ...
        public static final SqlPostfixOperator IS_UNKNOWN = new SqlPostfixOperator(
                        "IS UNKNOWN",
                        SqlKind.IS_NULL,
                        28,
                        ReturnTypes.BOOLEAN_NOT_NULL,
        ...
        public static final SqlPostfixOperator IS_A_SET = new SqlPostfixOperator(
                        "IS A SET",
                        SqlKind.OTHER,
                        28,
                        ReturnTypes.BOOLEAN,
        ...
        public static final SqlPostfixOperator IS_NOT_A_SET = new SqlPostfixOperator(
                        "IS NOT A SET",
                        SqlKind.OTHER,
                        28,
                        ReturnTypes.BOOLEAN,
        ...
        public static final SqlPostfixOperator IS_EMPTY = new SqlPostfixOperator(
                        "IS EMPTY",
                        SqlKind.OTHER,
                        28,
                        ReturnTypes.BOOLEAN,
        ...
        public static final SqlPostfixOperator IS_NOT_EMPTY = new SqlPostfixOperator(
                        "IS NOT EMPTY",
                        SqlKind.OTHER,
                        28,
                        ReturnTypes.BOOLEAN,
        ...
        public static final SqlPostfixOperator IS_JSON_VALUE = new SqlPostfixOperator(
                        "IS JSON VALUE",
                        SqlKind.OTHER,
                        28,
                        ReturnTypes.BOOLEAN,
        ...
        public static final SqlPostfixOperator IS_NOT_JSON_VALUE = new SqlPostfixOperator(
                        "IS NOT JSON VALUE",
                        SqlKind.OTHER,
                        28,
                        ReturnTypes.BOOLEAN,
        ...
        public static final SqlPostfixOperator IS_JSON_OBJECT = new SqlPostfixOperator(
                        "IS JSON OBJECT",
                        SqlKind.OTHER,
                        28,
                        ReturnTypes.BOOLEAN,
        ...
        public static final SqlPostfixOperator IS_NOT_JSON_OBJECT = new SqlPostfixOperator(
                        "IS NOT JSON OBJECT",
                        SqlKind.OTHER,
                        28,
                        ReturnTypes.BOOLEAN,
        ...
        public static final SqlPostfixOperator IS_JSON_ARRAY = new SqlPostfixOperator(
                        "IS JSON ARRAY",
                        SqlKind.OTHER,
                        28,
                        ReturnTypes.BOOLEAN,
        ...
        public static final SqlPostfixOperator IS_NOT_JSON_ARRAY = new SqlPostfixOperator(
                        "IS NOT JSON ARRAY",
                        SqlKind.OTHER,
                        28,
                        ReturnTypes.BOOLEAN,
        ...
        public static final SqlPostfixOperator IS_JSON_SCALAR = new SqlPostfixOperator(
                        "IS JSON SCALAR",
                        SqlKind.OTHER,
                        28,
                        ReturnTypes.BOOLEAN,
        ...
        public static final SqlPostfixOperator IS_NOT_JSON_SCALAR = new SqlPostfixOperator(
                        "IS NOT JSON SCALAR",
                        SqlKind.OTHER,
                        28,
                        ReturnTypes.BOOLEAN,
        ...
        // PREFIX OPERATORS
        // -------------------------------------------------------------
        public static final SqlPrefixOperator EXISTS = new SqlPrefixOperator(
                        "EXISTS",
                        SqlKind.EXISTS,
                        40,
                        ReturnTypes.BOOLEAN,
        ...
        public static final SqlPrefixOperator UNIQUE = new SqlPrefixOperator(
                        "UNIQUE",
                        SqlKind.UNIQUE,
                        40,
                        ReturnTypes.BOOLEAN,
         ...
         */
        public static final SqlPrefixOperator EXPLICIT_TABLE = new SqlPrefixOperator(
                        "TABLE",
        ...
        public static final SqlPrefixOperator FINAL = new SqlPrefixOperator(
                        "FINAL",
                        SqlKind.FINAL,
                        80,
        ...
        public static final SqlPrefixOperator RUNNING = new SqlPrefixOperator(
                        "RUNNING",
                        SqlKind.RUNNING,
                        80,
                        ReturnTypes.ARG0_NULLABLE,
         ...
         */
        public static final SqlAggFunction MODE = SqlBasicAggFunction
         ...
         */
        public static final SqlAggFunction SINGLE_VALUE = new SqlSingleValueAggFunction(castNonNull(null));
         ...
         */
        public static final SqlAggFunction HISTOGRAM_AGG = new SqlHistogramAggFunction(castNonNull(null));

        /**
         * <code>HISTOGRAM_MIN</code> window aggregate function.
         */
        public static final SqlFunction HISTOGRAM_MIN = new SqlFunction(
                        "$HISTOGRAM_MIN",
         ...
         */
        public static final SqlFunction HISTOGRAM_MAX = new SqlFunction(
                        "$HISTOGRAM_MAX",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.ARG0_NULLABLE,
                        null,
         ...
         */
        public static final SqlFunction HISTOGRAM_FIRST_VALUE = new SqlFunction(
         ...
         */
        public static final SqlFunction HISTOGRAM_LAST_VALUE = new SqlFunction(
         ...
         */
        public static final SqlRankFunction CUME_DIST = new SqlRankFunction(SqlKind.CUME_DIST,
         ...
         */
        public static final SqlRankFunction DENSE_RANK = new SqlRankFunction(SqlKind.DENSE_RANK, ReturnTypes.RANK,
                        true);
         ...
         */
        public static final SqlRankFunction ROW_NUMBER = new SqlRankFunction(SqlKind.ROW_NUMBER, ReturnTypes.RANK,
                        false);
        ...
        public static final SqlNullTreatmentOperator RESPECT_NULLS = new SqlNullTreatmentOperator(
        ...
        public static final SqlFunction PARSE_JSON = new SqlJsonParseJsonFunction();

        public static final SqlJsonObjectAggAggFunction JSON_OBJECTAGG = new SqlJsonObjectAggAggFunction(
        ...
        public static final SqlJsonArrayAggAggFunction JSON_ARRAYAGG = new SqlJsonArrayAggAggFunction(
                        SqlKind.JSON_ARRAYAGG,
                        SqlJsonConstructorNullClause.ABSENT_ON_NULL);

        public static final SqlBetweenOperator BETWEEN = new SqlBetweenOperator(
                        SqlBetweenOperator.Flag.ASYMMETRIC,
                        false);

        public static final SqlBetweenOperator SYMMETRIC_BETWEEN = new SqlBetweenOperator(
                        SqlBetweenOperator.Flag.SYMMETRIC,
                        false);

        public static final SqlBetweenOperator NOT_BETWEEN = new SqlBetweenOperator(
                        SqlBetweenOperator.Flag.ASYMMETRIC,
                        true);
        ...
        public static final SqlSpecialOperator LIKE = new SqlLikeOperator("LIKE", SqlKind.LIKE, false, true, false);

        public static final SqlSpecialOperator NOT_LIKE_ANY = new SqlLikeOperator("NOT LIKE", SqlKind.LIKE, true, true,
                        true);

        public static final SqlSpecialOperator LIKE_ANY = new SqlLikeOperator("LIKE", SqlKind.LIKE, false, true, true);
        ...
        public static final SqlBinaryOperator NEGATED_POSIX_REGEX_CASE_SENSITIVE = new SqlPosixRegexOperator(
                        "NEGATED POSIX REGEX CASE SENSITIVE",
                        SqlKind.POSIX_REGEX_CASE_SENSITIVE, true, true);

        public static final SqlBinaryOperator NEGATED_POSIX_REGEX_CASE_INSENSITIVE = new SqlPosixRegexOperator(
         ...
         * ({@code org.apache.calcite.sql.SqlWindow.SqlWindowOperator})</li>
         * </ol>
         */
         ...
         * true or not.
         */
        public static final SqlSpecialOperator REINTERPRET = new SqlSpecialOperator("Reinterpret",
                        SqlKind.REINTERPRET) {
                @Override
        ...
        /**
         * The <code>TRANSLATE(<i>char_value</i> USING <i>translation_name</i>)</code>
         * function
        ...
        public static final SqlFunction CHARACTER_LENGTH = new SqlFunction(
                        "CHARACTER_LENGTH",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.INTEGER_NULLABLE,
                        null,
        ...
        public static final SqlFunction OCTET_LENGTH = new SqlFunction(
                        "OCTET_LENGTH",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.INTEGER_NULLABLE,
                        null,
        ...
        public static final SqlFunction UPPER = new SqlFunction(
                        "UPPER",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.ARG0_NULLABLE,
                        null,
        ...
        public static final SqlFunction LOWER = new SqlFunction(
                        "LOWER",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.ARG0_NULLABLE,
                        null,
        ...
        public static final SqlFunction INITCAP = new SqlFunction(
                        "INITCAP",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.ARG0_NULLABLE,
                        null,
         ...
         * negative.
         */
        public static final SqlFunction POWER = new SqlFunction(
                        "POWER",
                        SqlKind.OTHER_FUNCTION,
        ...
        public static final SqlFunction SQRT = new SqlFunction(
                        "SQRT",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.DOUBLE_NULLABLE,
                        null,
        ...
        public static final SqlFunction LN = new SqlFunction(
                        "LN",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.DOUBLE_NULLABLE,
                        null,
        ...
        public static final SqlFunction LOG10 = new SqlFunction(
                        "LOG10",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.DOUBLE_NULLABLE,
                        null,
        ...
        public static final SqlFunction ACOS = new SqlFunction(
                        "ACOS",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.DOUBLE_NULLABLE,
                        null,
        ...
        public static final SqlFunction ASIN = new SqlFunction(
                        "ASIN",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.DOUBLE_NULLABLE,
                        null,
        ...
        public static final SqlFunction ATAN = new SqlFunction(
                        "ATAN",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.DOUBLE_NULLABLE,
                        null,
        ...
        public static final SqlFunction ATAN2 = new SqlFunction(
                        "ATAN2",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.DOUBLE_NULLABLE,
                        null,
        ...
        public static final SqlFunction CBRT = new SqlFunction(
                        "CBRT",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.DOUBLE_NULLABLE,
                        null,
        ...
        public static final SqlFunction COS = new SqlFunction(
                        "COS",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.DOUBLE_NULLABLE,
                        null,
        ...
        public static final SqlFunction COT = new SqlFunction(
                        "COT",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.DOUBLE_NULLABLE,
                        null,
        ...
        public static final SqlFunction DEGREES = new SqlFunction(
                        "DEGREES",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.DOUBLE_NULLABLE,
                        null,
        ...
        public static final SqlFunction EXP = new SqlFunction(
                        "EXP",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.DOUBLE_NULLABLE,
                        null,
        ...
        public static final SqlFunction RADIANS = new SqlFunction(
                        "RADIANS",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.DOUBLE_NULLABLE,
                        null,
        ...
        public static final SqlFunction SIN = new SqlFunction(
                        "SIN",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.DOUBLE_NULLABLE,
                        null,
        ...
        public static final SqlFunction TAN = new SqlFunction(
                        "TAN",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.DOUBLE_NULLABLE,
                        null,
        ...
        public static final SqlFunction FIRST = new SqlFunction("FIRST", SqlKind.FIRST, ReturnTypes.ARG0_NULLABLE,
        ...
        public static final SqlMatchFunction LAST = new SqlMatchFunction("LAST", SqlKind.LAST,
                        ReturnTypes.ARG0_NULLABLE,
                        null, OperandTypes.ANY_NUMERIC, SqlFunctionCategory.MATCH_RECOGNIZE);

        /** {@code PREV} function to be used within {@code MATCH_RECOGNIZE}. */
        public static final SqlMatchFunction PREV = new SqlMatchFunction("PREV", SqlKind.PREV,
                        ReturnTypes.ARG0_NULLABLE,
                        null, OperandTypes.ANY_NUMERIC, SqlFunctionCategory.MATCH_RECOGNIZE);
        ...
        public static final SqlMatchFunction CLASSIFIER = new SqlMatchFunction("CLASSIFIER", SqlKind.CLASSIFIER,
         ...
         */
        public static final SqlFunction IN_FENNEL = new SqlMonotonicUnaryFunction(
                        "$IN_FENNEL",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.ARG0,
                        null,
         ...
         *
         * <p>
         * When the CAST operator is applies as a {@link SqlCall}, it has two
         ...
         *
         * <p>
         * When the CAST operator is applied as a <code>RexCall</code>, the
         ...
         *
         * <p>
         * The <code>RexCall</code> form can also have a type which contains a
        ...
        public static final SqlFunction TRY_CAST = new SqlCastFunction(true);
        ...
        public static final SqlFunction LAST_DAY = new SqlFunction(
                        "LAST_DAY",
                        SqlKind.OTHER_FUNCTION,
         ...
         */
        public static final SqlFunction ELEMENT = new SqlFunction(
                        "ELEMENT",
                        SqlKind.OTHER_FUNCTION,
         ...
         * array, map or struct. For example, {@code myArray[3]},
         * {@code "myMap['foo']"},
         ...
         *
         * <p>
         * <code>$SLICE</code> is often translated away when the multiset type is
         * converted back to scalar values.
         */
        public static final SqlInternalOperator SLICE = new SqlInternalOperator(
                        "$SLICE",
                        SqlKind.OTHER,
                        0,
                        false,
         ...
         * </p>
         */
        public static final SqlInternalOperator ELEMENT_SLICE = new SqlInternalOperator(
                        "$ELEMENT_SLICE",
                        SqlKind.OTHER,
                        0,
                        false,
         ...
         */
        public static final SqlInternalOperator SCALAR_QUERY = new SqlInternalOperator(
                        "$SCALAR_QUERY",
         ...
         *
         * <p>
         * In contrast with {@link #DOT} operator, it never appears in an
         * {@link SqlNode} tree and allows to access fields by position and
         * not by name.
         */
        public static final SqlInternalOperator STRUCT_ACCESS = new SqlInternalOperator("$STRUCT_ACCESS",
                        SqlKind.OTHER);
         ...
         */
        public static final SqlFunction CARDINALITY = new SqlFunction(
                        "CARDINALITY",
                        SqlKind.OTHER_FUNCTION,
                        ReturnTypes.INTEGER_NULLABLE,
                        null,
         ...
         */
        public static final SqlAggFunction COLLECT = SqlBasicAggFunction
         ...
         */
        public static final SqlAggFunction PERCENTILE_CONT = SqlBasicAggFunction
         ...
         */
        public static final SqlAggFunction PERCENTILE_DISC = SqlBasicAggFunction
         ...
         */
        public static final SqlAggFunction LISTAGG = new SqlListaggAggFunction(SqlKind.LISTAGG,
                        ReturnTypes.ARG0_NULLABLE);

        /**
         * The FUSION operator. Multiset aggregator function.
         */
        public static final SqlAggFunction FUSION = SqlBasicAggFunction
         ...
         */
        public static final SqlAggFunction INTERSECTION = SqlBasicAggFunction
         ...
         *
         * <p>
         * Operand #0 is a query or table; Operand #1 is a {@link SqlSampleSpec}
         * wrapped in a {@link SqlLiteral}.
         */
        public static final SqlSpecialOperator TABLESAMPLE = new SqlSpecialOperator(
                        "TABLESAMPLE",
                        SqlKind.TABLESAMPLE,
                        20,
                        true,
         ...
         */
        public static final SqlGroupedWindowFunction TUMBLE_OLD = new SqlGroupedWindowFunction("$TUMBLE",
                        SqlKind.TUMBLE,
        ...
        public static final SqlGroupedWindowFunction HOP_OLD = new SqlGroupedWindowFunction("$HOP", SqlKind.HOP, null,
        ...
        public static final SqlGroupedWindowFunction SESSION_OLD = new SqlGroupedWindowFunction("$SESSION",
                        SqlKind.SESSION,
                        null, ReturnTypes.ARG0, null,
                        OperandTypes.or(OperandTypes.DATETIME_INTERVAL,
                                        OperandTypes.DATETIME_INTERVAL_TIME),
         ...
         *
         * <p>
         * If {@code p1} and {@code p2} are patterns then {@code p1 | p2} is a
         * pattern that matches {@code p1} or {@code p2}.
         */
        public static final SqlBinaryOperator PATTERN_ALTER = new SqlBinaryOperator("|", SqlKind.PATTERN_ALTER, 70,
                        true,
                        null, null, null);
         ...
         */
        public static final SqlBinaryOperator PATTERN_CONCAT = new SqlBinaryOperator("", SqlKind.PATTERN_CONCAT, 80,
                        true,
                        null, null, null);
         ...
         *
         * <p>
         * If {@code p} is a pattern then {@code p{3, 5}} is a
         ...
         *
         * <p>
         * If {@code p1} and {@code p2} are patterns then {@code PERMUTE (p1, p2)}
         ...
         *
         * <p>
         * If {@code p} is a pattern then {@code {- p -} }} is a
         ...
         *
         * <p>
         * For example, converts {@code TUMBLE_START(rowtime, INTERVAL '1' HOUR))}
        ...
        public static List<Pair<SqlNode, AuxiliaryConverter>> convertGroupToAuxiliaryCalls(
                ...
                if (op instanceof SqlGroupedWindowFunction
                        ...
                        for (final SqlGroupedWindowFunction f : ((SqlGroupedWindowFunction) op)
        ...
        /**
         * Returns the binary operator that corresponds to this operator but in the
         * opposite
