...
/**
 * The REGEXP_SUBSTR(source_string, pattern, position, occurrence, match_parameter, subexpression) extracts a
 * substring from source_string that matches a regular expression specified by regex_pattern.
 */
public class OracleSqlRegexpSubstrFunction extends SqlFunction {

  public OracleSqlRegexpSubstrFunction() {
    super(
        "REGEXP_SUBSTR",
