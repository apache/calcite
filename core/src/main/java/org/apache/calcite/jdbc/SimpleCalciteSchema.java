...
class SimpleCalciteSchema extends CalciteSchema {
  ...
  @Override
  void addImplicitSubSchemaToBuilder(ImmutableSortedMap.Builder<String, CalciteSchema> builder) {
  ...
  @Override
  void addImplicitTableToBuilder(ImmutableSortedSet.Builder<String> builder) {
  ...
  @Override
  void addImplicitTableFuncToBuilder(ImmutableSortedMap.Builder<String, Table> builder) {
