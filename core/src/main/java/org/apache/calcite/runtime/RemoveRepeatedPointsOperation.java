 ...
 */
public class RemoveRepeatedPointsOperation extends GeometryTransformer {

  private double tolerance = 0;

  public RemoveRepeatedPointsOperation() {
    super();
  }

  public RemoveRepeatedPointsOperation(double tolerance) {
    super();
