...
public class JsonFunctions {
  ...
  @Deterministic
  public static class CacheableJsonFunction {
    ...
    public JsonPathContext jsonApiCommonSyntaxWithCache(String input, String pathSpec) {
    ...
    public @Nullable Boolean jsonExists(String input, String pathSpec,
      ...
      return jsonExists(jsonApiCommonSyntaxWithCache(input, pathSpec), errorBehavior);
    }
