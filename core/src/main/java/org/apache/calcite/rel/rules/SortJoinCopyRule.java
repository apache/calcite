 ...
 *
 * Some examples where {@link org.apache.calcite.rel.rules.SortJoinCopyRule} can be helpful are:
 * allowing a {@link org.apache.calcite.rel.core.Sort} to be incorporated in an index scan,
 * making the use of operators requiring sorted inputs easier, and reducing the size
 * of the relations being sorted.
 *
 * Currently {@link org.apache.calcite.rel.rules.SortJoinCopyRule}
 * is not part of the "default" calcite rule set.
 */
