...
public class UnionPullUpConstantsRule extends RelOptRule {
  ...
  protected UnionPullUpConstantsRule(
  ...
  @Override public void onMatch(RelOptRuleCall call) {
    ...
    Map<RexNode, RexNode> conditionsExtracted = ReduceExpressionsRule.predicateConstants(
    ...
    for (int i = 0; i < union.getInputs().size(); i++) {
      ...
      if (newChildExprs.isEmpty()) {
        ...
        newChildExprs.add(
            Pair.<RexNode, String>of(topChildExprs.get(0), topChildExprsFields.get(0)));
      }
