...
public abstract class BuiltInMetadata {
  ...
  public interface ExpressionLineage extends Metadata {
     ...
     *
     * <p>For example, if the expression is {@code _0 + 2} and {@code _0} originated
     * from column {@code _3} in the {@code 0} occurrence of table {@code A} in the
     * plan, result will be: {@code A.#0._3 + 2}. Occurrences are generated in no
