 ...
 * a {@link org.apache.calcite.rel.core.Sort} if some/all of the keys are constant
 *
...
public class SortRemoveConstantKeysRule extends RelOptRule {
  ...
  @Override public void onMatch(RelOptRuleCall call) {
    ...
    Sort result = sort.copy(sort.getTraitSet(), sort.getInput(), RelCollations.of(collationsList));
