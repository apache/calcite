...
public class RelMdPredicates
   ...
   *
   * <p>Examples:<ol>
   * <li>The predicate {@code _7 = _9} on columns [7]
   *     becomes {@code _7 is not null}
   * <li>The predicate {@code _7 = _9 + _11} on columns [7, 9]
   *     becomes {@code _7 is not null or _9 is not null}
   * <li>The predicate {@code _7 = _9 and _9 = 5} on columns [7] becomes
   *   {@code _7 = 5}
   * <li>The predicate
   *   {@code _7 = _9 and (_9 = _1 or _9 = _2) and _1 > 3 and _2 > 10}
   *   on columns [7] becomes {@code _7 > 3}
   * </ol>
   *
