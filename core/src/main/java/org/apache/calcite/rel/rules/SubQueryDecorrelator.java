...
public class SubQueryDecorrelator extends RelShuttleImpl {
    ...
    public static class SubQueryRelDecorrelator implements ReflectiveVisitor {
        ...
        private static Map<Integer, Integer> identityMap(int count) {
            com.google.common.collect.ImmutableMap.Builder<Integer, Integer> builder = com.google.common.collect.ImmutableMap.builder();
    ...
    private static class CorelMapBuilder extends RelShuttleImpl {
        ...
        final com.google.common.collect.SortedSetMultimap<RelNode, CorRef> mapRefRelToCorRef = com.google.common.collect.Multimaps
            .newSortedSetMultimap(new HashMap<RelNode, Collection<CorRef>>(), new com.google.common.base.Supplier<TreeSet<CorRef>>() {
