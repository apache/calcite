...
public enum BuiltInMethod {
  ...
  JSON_QUOTE(JsonFunctions.class, "jsonQuote", String.class),
  JSON_UNQUOTE(JsonFunctions.class, "jsonUnQuote", String.class, String.class),
  ...
  SQL_MODE(SqlFunctions.class, "sqlMode", DataContext.class),
