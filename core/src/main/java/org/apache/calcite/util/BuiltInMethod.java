...
public enum BuiltInMethod {
  ...
  REGEXP_CONTAINS(SqlFunctions.class, "regexpContains", String.class,
      String.class),
  ...
  PARSE_DATE(SqlFunctions.class, "parseDate", String.class, String.class),
  PARSE_DATETIME(SqlFunctions.class, "parseDatetime", String.class,
      String.class),
  PARSE_TIME(SqlFunctions.class, "parseTime", String.class, String.class),
  PARSE_TIMESTAMP(SqlFunctions.class, "parseTimestamp", String.class,
      String.class),
