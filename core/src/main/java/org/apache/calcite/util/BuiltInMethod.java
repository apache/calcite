...
public enum BuiltInMethod {
  ...
  TO_TIMESTAMP_LTZ(SqlFunctions.class, "toTimestampLtz", long.class),
  TO_TIMESTAMP_LTZ_DATE(SqlFunctions.class, "toTimestampLtzDate", int.class),
  TO_TIMESTAMP_LTZ_TIMESTAMP(SqlFunctions.class, "toTimestampLtzTimestamp", long.class),
