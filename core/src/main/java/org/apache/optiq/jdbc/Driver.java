...
import org.apache.optiq.model.ModelHandler;
...
public class Driver extends UnregisteredDriver {
  ...
  protected String getFactoryClassName(JdbcVersion jdbcVersion) {
    switch (jdbcVersion) {
    case JDBC_30:
      return "org.apache.optiq.jdbc.OptiqJdbc3Factory";
    case JDBC_40:
      return "org.apache.optiq.jdbc.OptiqJdbc40Factory";
    case JDBC_41:
    default:
      return "org.apache.optiq.jdbc.OptiqJdbc41Factory";
    }
  }
  ...
  protected DriverVersion createDriverVersion() {
    return DriverVersion.load(
        Driver.class,
        "org-apache-optiq-jdbc.properties",
        "Optiq JDBC Driver",
        "unknown version",
        "Optiq",
        "unknown version");
