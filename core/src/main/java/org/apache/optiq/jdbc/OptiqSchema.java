...
import org.apache.optiq.impl.MaterializedViewTable;
...
public class OptiqSchema {
   ...
   * {@link #add(String, org.apache.optiq.Schema)}) and implicit
   * (defined using {@link org.apache.optiq.Schema#getSubSchemaNames()}
  ...
  private class SchemaPlusImpl implements SchemaPlus {
    ...
    public void add(String name, org.apache.optiq.Function function) {
      OptiqSchema.this.add(name, function);
    }
  }

  /**
   * Implementation of {@link org.apache.optiq.jdbc.OptiqSchema.TableEntry}
  ...
  /** Implementation of {@link org.apache.optiq.jdbc.OptiqSchema.Cached}
   * that drives from {@link org.apache.optiq.jdbc.OptiqSchema#cache}. */
  ...
  private static class SubSchemaCache {
    ...
    /** Cached {@link org.apache.optiq.jdbc.OptiqSchema} wrappers. It is
