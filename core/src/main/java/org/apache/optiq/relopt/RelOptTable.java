...
public interface RelOptTable {
   ...
   *
   * <p>The {@link org.apache.optiq.relopt.RelOptPlanner planner} calls this
   * method to convert a table into an initial relational expression,
   * generally something abstract, such as a {@link
   * org.apache.optiq.rel.TableAccessRel}, then optimizes this expression by
   * applying {@link org.apache.optiq.relopt.RelOptRule rules} to transform it
