 ...
 * {@link org.apache.optiq.rel.RelNode relational expression}.</p>
 *
 * <p>Interface {@link org.apache.optiq.relopt.RelOptPlanner} defines a planner,
 * and class {@link org.apache.optiq.relopt.volcano.VolcanoPlanner} is an
 * implementation which uses a dynamic programming technique. It is based upon
 * the Volcano optimizer [<a href="#graefe93">1</a>].</p>
 *
 * <p>Interface {@link org.apache.optiq.relopt.RelOptCost} defines a cost
 * model; class {@link org.apache.optiq.relopt.volcano.VolcanoCost} is
 * the implementation for a <code>VolcanoPlanner</code>.</p>
 *
 * <p>A {@link org.apache.optiq.relopt.volcano.RelSet} is a set of equivalent
 ...
 * {@link org.apache.optiq.relopt.RelTraitDef}.  Manifestations of the trait
 * implement {@link org.apache.optiq.relopt.RelTrait}. The most common example of a
 * trait is calling convention: the protocol used to receive and transmit
 * data. {@link org.apache.optiq.relopt.ConventionTraitDef} defines the trait and
 * {@link org.apache.optiq.relopt.Convention} enumerates the protocols. Every
 * relational expression has a single calling convention by which it returns its
 * results. Some examples:</p>
 *
 * <ul>
 *     <li>{@link org.apache.optiq.impl.jdbc.JdbcConvention} is a fairly
 *         conventional convention; the results are rows from a
 *         {@link java.sql.ResultSet JDBC result set}.
 *     </li>
 *     <li>{@link org.apache.optiq.relopt.Convention#NONE} means that a
 *         relational
 *         expression cannot be implemented; typically there are rules which can
 *         transform it to equivalent, implementable expressions.
 *     </li>
 *     <li>{@link org.apache.optiq.impl.enumerable.EnumerableConvention}
 ...
 *         implementation of {@link org.apache.optiq.rel.RelNode} should include
 *         its manifestation of the trait as part of the
 *         {@link org.apache.optiq.relopt.RelTraitSet} passed to
 *         {@link org.apache.optiq.rel.AbstractRelNode}'s constructor. It may be
 ...
 *         {@link org.apache.optiq.relopt.volcano.VolcanoPlanner#setRoot(org.apache.optiq.rel.RelNode)}
 ...
 *     org.apache.optiq.rel.AbstractRelNode#clone()} must
 *     not assume the type and quantity of traits in
 *     their trait set. In either case, the new <code>RelTraitDef</code>
 *     implementation must be
 *     {@link org.apache.optiq.relopt.volcano.VolcanoPlanner#addRelTraitDef(org.apache.optiq.relopt.RelTraitDef)}
 *     registered with the planner.</p>
 *
 * <p>A {@link org.apache.optiq.relopt.volcano.RelSubset} is a
 *     subset of a <code>RelSet</code>
 ...
 * <ul>
 *     <li>{@code <a href="../rel/package-summary.html">org.apache.optiq.rel</a>}
 *         defines {@link org.apache.optiq.rel.RelNode relational expressions}.
 *     </li>
 * </ul>
 *
 * <h2>Details</h2>
