...
public interface RelOptPlanner {
   ...
   * org.apache.optiq.rel.convert.ConverterRule} and pass the ConverterRule to
  ...
  /**
   * Returns the factory that creates {@link org.apache.optiq.relopt.RelOptCost}s.
   */
  ...
  /**
   * Thrown by {@link org.apache.optiq.relopt.RelOptPlanner#findBestExp()}.
   */
