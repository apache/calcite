...
public interface Planner {
   ...
   * @throws org.apache.optiq.sql.parser.SqlParseException on parse error
   */
   ...
   *
   * <p>You must call {@link #validate(org.apache.optiq.sql.SqlNode)} first.</p>
   *
   * @param sql The root node of the SQL parse tree.
   * @return The root node of the newly generated RelNode tree.
   * @throws org.apache.optiq.tools.RelConversionException if the node
   ...
   * @throws org.apache.optiq.tools.RelConversionException on conversion
   *     error
   */
