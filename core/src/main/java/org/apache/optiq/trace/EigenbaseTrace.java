...
import org.apache.linq4j.function.Function2;
 ...
 * org.apache.optiq class libraries.
 *
 * <h3>Note to developers</h3>
 *
 * <p>Please ensure that every tracer used in org.apache.optiq is added to this
...
public abstract class EigenbaseTrace {
  ...
  /**
   * The "org.apache.optiq.sql.parser" tracer reports parser events in {@link
   * org.apache.optiq.sql.parser.SqlParser} and other classes (at level {@link
  ...
  /**
   * The "org.apache.optiq.relopt.RelOptPlanner" tracer prints the query
  ...
  /**
   * The "org.apache.optiq.prepare.Prepare" tracer prints the generated
  ...
  /**
   * The "org.apache.optiq.rel.RelImplementorImpl" tracer reports when
  ...
  /**
   * The tracer "org.apache.optiq.sql.timing" traces timing for
   * various stages of query processing.
   *
   * @see EigenbaseTimingTracer
   */
  public static Logger getSqlTimingTracer() {
    return Logger.getLogger("org.apache.optiq.sql.timing");
  }

  /**
   * The "org.apache.optiq.sql.parser" tracer reports parse events.
   */
  public static Logger getParserTracer() {
    return Logger.getLogger("org.apache.optiq.sql.parser");
  }

  /**
   * The "org.apache.optiq.sql2rel" tracer reports parse events.
   */
  public static Logger getSqlToRelTracer() {
    return Logger.getLogger("org.apache.optiq.sql2rel");
  }

  /**
   * The "org.apache.optiq.jmi.JmiChangeSet" tracer reports JmiChangeSet events.
   */
  public static Logger getJmiChangeSetTracer() {
    return Logger.getLogger("org.apache.optiq.jmi.JmiChangeSet");
  }

  /**
   * The "org.apache.optiq.util.property.Property" tracer reports errors related
