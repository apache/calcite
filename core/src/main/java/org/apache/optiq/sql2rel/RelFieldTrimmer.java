...
*/
package org.apache.optiq.sql2rel;

import java.math.BigDecimal;
import java.util.*;

import org.apache.optiq.rel.*;
import org.apache.optiq.rel.rules.RemoveTrivialProjectRule;
...
public class RelFieldTrimmer implements ReflectiveVisitor {
  ...
  /**
   * Visit method, per {@link org.apache.optiq.util.ReflectiveVisitor}.
   *
  ...
  /**
   * Variant of {@link #trimFields(RelNode, BitSet, Set)} for
   * {@link org.apache.optiq.rel.ValuesRel}.
   */
  public TrimResult trimFields(
      ValuesRel values,
      BitSet fieldsUsed,
  ...
  /**
   * Variant of {@link #trimFields(RelNode, BitSet, Set)} for
   * {@link org.apache.optiq.rel.TableAccessRel}.
   */
  public TrimResult trimFields(
   ...
   *
   * <p>The mapping is a
   * {@link org.apache.optiq.util.mapping.Mappings.SourceMapping}, which means
