...
import org.apache.optiq.prepare.RelOptTableImpl;
...
/**
 * Converts a SQL parse tree (consisting of {@link org.apache.optiq.sql.SqlNode}
 * objects) into a relational algebra expression (consisting of
 * {@link org.apache.optiq.rel.RelNode} objects).
 *
