...
import org.apache.optiq.sql.pretty.*;
...
public abstract class SqlNode implements Cloneable {
   ...
   * org.apache.optiq.sql.SqlKind#OTHER} if it's nothing special.
   *
   ...
   * <code>visit</code> method on the {@link org.apache.optiq.sql.util.SqlVisitor
   * visitor object}.
   *
