...
import org.apache.optiq.rex.RexWindowBound;
import org.apache.optiq.sql.parser.*;
import org.apache.optiq.sql.type.ReturnTypes;
import org.apache.optiq.sql.type.SqlTypeFamily;
import org.apache.optiq.sql.util.SqlBasicVisitor;
import org.apache.optiq.sql.util.SqlVisitor;
...
public class SqlWindow extends SqlCall {
   ...
   * @see org.apache.optiq.rel.WindowRelBase.Window#isAlwaysNonEmpty()
   * @see SqlOperatorBinding#getGroupCount()
   * @see org.apache.optiq.sql.validate.SqlValidatorImpl#resolveWindow(SqlNode, org.apache.optiq.sql.validate.SqlValidatorScope, boolean)
   */
