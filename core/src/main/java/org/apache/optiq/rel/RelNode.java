 ...
 * {@link org.apache.optiq.sql.SqlNode} and {@link RexNode}.</p>
 *
 ...
 * a {@link org.apache.optiq.relopt.RelImplementor} to manage the process. Every
 ...
 * RelNode. For example, {@code org.apache.optiq.impl.enumerable.EnumerableRel}
 * has operations to manage the conversion to a graph of
 * {@code org.apache.optiq.impl.enumerable.EnumerableConvention}
...
public interface RelNode extends RelOptNode, Cloneable {
   ...
   * org.apache.optiq.util.Glossary#VISITOR_PATTERN visitor pattern} to traverse
   ...
   * org.apache.optiq.rel.ArrayRel.ArrayReader</code>, this method returns
   * "ArrayReader".
   */
   ...
   * org.apache.optiq.relopt.RelOptPlanner#addRule} for each rule, and then call
