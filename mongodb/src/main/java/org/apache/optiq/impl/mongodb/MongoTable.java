...
public class MongoTable extends AbstractQueryableTable
  ...
  /** Implementation of {@link org.apache.linq4j.Queryable} based on
   * a {@link org.apache.optiq.impl.mongodb.MongoTable}. */
  public static class MongoQueryable<T> extends AbstractTableQueryable<T> {
     ...
     *
     * @see org.apache.optiq.impl.mongodb.MongoMethod#MONGO_QUERYABLE_AGGREGATE
     */
    ...
    /** Called via code-generation.
     *
     * @see org.apache.optiq.impl.mongodb.MongoMethod#MONGO_QUERYABLE_FIND
     */
    @SuppressWarnings("UnusedDeclaration")
